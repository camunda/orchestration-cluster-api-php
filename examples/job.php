 ...
 * Update job.
 */
function update_job(CamundaClient $client, string $jobKey, \Camunda\Orchestration\Api\Model\JobUpdateRequest $jobUpdateRequest): void
{
    $client->updateJob($jobKey, $jobUpdateRequest);
}
// endregion UpdateJob
