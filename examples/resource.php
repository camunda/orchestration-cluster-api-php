 ...
 * Get resource.
 */
function get_resource(CamundaClient $client, \Camunda\Orchestration\Api\Model\ResourceKey $resourceKey): void
{
 ...
 */
function get_resource_content(CamundaClient $client, \Camunda\Orchestration\Api\Model\ResourceKey $resourceKey): void
{
 ...
 */
function get_resource_content_binary(CamundaClient $client, \Camunda\Orchestration\Api\Model\ResourceKey $resourceKey): void
{
 ...
 * Delete resource.
 */
function delete_resource(CamundaClient $client, \Camunda\Orchestration\Api\Model\ResourceKey $resourceKey, ?\Camunda\Orchestration\Api\Model\DeleteResourceRequest $deleteResourceRequest = null): void
{
