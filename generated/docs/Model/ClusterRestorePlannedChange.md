...
**operations** | [**\Camunda\Orchestration\Api\Model\ClusterRestoreOperation[]**](ClusterRestoreOperation.md) | The ordered list of operations that will be applied to the physical tenant. |
