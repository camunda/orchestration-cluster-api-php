 ...
 */
final class Tag implements SemanticKey
{
    public const NAME = 'Tag';

    public const PATTERN = '/^[A-Za-z][A-Za-z0-9_\-:.]{0,99}$/u';
    ...
    public function __construct(private readonly string $value)
    {
        ...
        if (mb_strlen($value) > 100) {
            throw new InvalidArgumentException(sprintf('%s must be at most 100 character(s)', self::NAME));
        }
    }
