...
class Configuration
{
     ...
     * @var string
     */
    protected string $host = 'http://localhost:8080/v2';
     ...
     * @var string
     */
    protected string $userAgent = 'OpenAPI-Generator/0.1.0/PHP';
    ...
    {
        $report  = 'PHP SDK (Camunda\Orchestration\Api) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 0.1' . PHP_EOL;
