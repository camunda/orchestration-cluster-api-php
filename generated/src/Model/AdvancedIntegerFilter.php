...
/**
 * AdvancedIntegerFilter Class Doc Comment
 *
 ...
 */
class AdvancedIntegerFilter implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'AdvancedIntegerFilter';
     ...
     * Sets eq
     *
     * @param int|null $eq Checks for equality with the provided value.
     *
     * @return $this
     */
    public function setEq(?int $eq): static
    {
        if (is_null($eq)) {
     ...
     * Sets neq
     *
     * @param int|null $neq Checks for inequality with the provided value.
     *
     * @return $this
     */
    public function setNeq(?int $neq): static
    {
        if (is_null($neq)) {
     ...
     * Sets gt
     *
     * @param int|null $gt Greater than comparison with the provided value.
     *
     * @return $this
     */
    public function setGt(?int $gt): static
    {
        if (is_null($gt)) {
     ...
     * Sets gte
     *
     * @param int|null $gte Greater than or equal comparison with the provided value.
     *
     * @return $this
     */
    public function setGte(?int $gte): static
    {
        if (is_null($gte)) {
     ...
     * Sets lt
     *
     * @param int|null $lt Lower than comparison with the provided value.
     *
     * @return $this
     */
     ...
     * Sets lte
     *
     * @param int|null $lte Lower than or equal comparison with the provided value.
     *
     * @return $this
     */
    public function setLte(?int $lte): static
    {
        if (is_null($lte)) {
     ...
     * Sets in
     *
     * @param int[]|null $in Checks if the property matches any of the provided values.
     *
     * @return $this
     */
