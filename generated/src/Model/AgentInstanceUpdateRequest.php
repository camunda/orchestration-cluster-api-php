...
/**
 * AgentInstanceUpdateRequest Class Doc Comment
 *
 ...
 */
class AgentInstanceUpdateRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'AgentInstanceUpdateRequest';
    ...
    protected static array $openAPITypes = [
        ...
        'status' => '\Camunda\Orchestration\Api\Model\AgentInstanceUpdateStatusEnum',
     ...
     * Gets status
     *
     * @return \Camunda\Orchestration\Api\Model\AgentInstanceUpdateStatusEnum|null
     */
    public function getStatus(): ?\Camunda\Orchestration\Api\Model\AgentInstanceUpdateStatusEnum
    {
     ...
     * Sets status
     *
     * @param \Camunda\Orchestration\Api\Model\AgentInstanceUpdateStatusEnum|null $status The new status of the agent instance.
     *
     * @return $this
     */
    public function setStatus(?\Camunda\Orchestration\Api\Model\AgentInstanceUpdateStatusEnum $status): static
    {
        if (is_null($status)) {
     ...
     * Sets jobKey
     *
     * @param string $jobKey The key of the job activation during which this update is being made. An update must always be attributed to the active job that produced it.
     *
     * @return $this
     */
     ...
     * Gets history
     *
     * @return \Camunda\Orchestration\Api\Model\AgentInstanceHistoryItem[]|null
     */
     ...
     * Sets history
     *
     * @param \Camunda\Orchestration\Api\Model\AgentInstanceHistoryItem[]|null $history A batch of history items to append to the agent instance's conversation history, in request order. Each created item is echoed back in the response's createdHistory, positionally correlated.
     *
     * @return $this
     */
