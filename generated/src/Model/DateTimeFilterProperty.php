...
/**
 * DateTimeFilterProperty Class Doc Comment
 *
 ...
 * @link     https://openapi-generator.tech
 */
class DateTimeFilterProperty implements OneOfInterface
{
    /**
     ...
     * @var string
     */
    public const MODEL_NAME = 'DateTimeFilterProperty';
    ...
    public static function getOneOfTypes(): array
    {
        return [
            '\DateTime',
            '\Camunda\Orchestration\Api\Model\AdvancedDateTimeFilter'
        ];
    }
