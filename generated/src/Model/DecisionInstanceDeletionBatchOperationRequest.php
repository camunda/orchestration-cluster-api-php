...
/**
 * DecisionInstanceDeletionBatchOperationRequest Class Doc Comment
 *
 ...
 */
class DecisionInstanceDeletionBatchOperationRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'DecisionInstanceDeletionBatchOperationRequest';
     ...
     * Gets filter
     *
     * @return \Camunda\Orchestration\Api\Model\DecisionInstanceFilter
     */
     ...
     * Sets filter
     *
     * @param \Camunda\Orchestration\Api\Model\DecisionInstanceFilter $filter The decision instance filter.
     *
     * @return $this
     */
    ...
    public function setOperationReference(?int $operationReference): static
    {
        ...
        if (($operationReference < 1)) {
            throw new InvalidArgumentException('invalid value for $operationReference when calling DecisionInstanceDeletionBatchOperationRequest., must be bigger than or equal to 1.');
        }
