...
/**
 * DeleteDecisionInstanceRequest Class Doc Comment
 *
 * @package  Camunda\Orchestration\Api
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class DeleteDecisionInstanceRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'DeleteDecisionInstanceRequest';
    ...
    public function setOperationReference(?int $operationReference): static
    {
        ...
        if (($operationReference < 1)) {
            throw new InvalidArgumentException('invalid value for $operationReference when calling DeleteDecisionInstanceRequest., must be bigger than or equal to 1.');
        }
