...
/**
 * DeleteResourceRequest Class Doc Comment
 *
 * @package  Camunda\Orchestration\Api
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class DeleteResourceRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'DeleteResourceRequest';
    ...
    protected static array $setters = [
        ...
        'deleteHistory' => 'setDeleteHistory'
    ];
    ...
    protected static array $getters = [
        ...
        'deleteHistory' => 'getDeleteHistory'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('deleteHistory', $data ?? [], false);
    }
    ...
    public function setOperationReference(?int $operationReference): static
    {
        ...
        if (($operationReference < 1)) {
            throw new InvalidArgumentException('invalid value for $operationReference when calling DeleteResourceRequest., must be bigger than or equal to 1.');
        }
     ...
     * @return bool|null
     */
    public function getDeleteHistory(): ?bool
    {
        return $this->container['deleteHistory'];
    }
     ...
     * @return $this
     */
    public function setDeleteHistory(?bool $deleteHistory): static
    {
        if (is_null($deleteHistory)) {
            throw new InvalidArgumentException('non-nullable deleteHistory cannot be null');
        }
        $this->container['deleteHistory'] = $deleteHistory;
