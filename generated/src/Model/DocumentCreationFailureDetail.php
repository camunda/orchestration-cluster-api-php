...
/**
 * DocumentCreationFailureDetail Class Doc Comment
 *
 * @package  Camunda\Orchestration\Api
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class DocumentCreationFailureDetail implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'DocumentCreationFailureDetail';
     ...
     * Sets status
     *
     * @param int $status The HTTP status code of the failure.
     *
     * @return $this
     */
