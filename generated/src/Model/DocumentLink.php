...
class DocumentLink implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'DocumentLink';
     ...
     * Sets url
     *
     * @param string $url The link to the document.
     *
     * @return $this
     */
     ...
     * Sets expiresAt
     *
     * @param \DateTime $expiresAt The date and time when the link expires.
     *
     * @return $this
     */
