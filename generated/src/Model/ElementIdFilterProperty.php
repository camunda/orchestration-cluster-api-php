...
/**
 * ElementIdFilterProperty Class Doc Comment
 *
 ...
 * @link     https://openapi-generator.tech
 */
class ElementIdFilterProperty implements OneOfInterface
{
    /**
     ...
     * @var string
     */
    public const MODEL_NAME = 'ElementIdFilterProperty';
    ...
    public static function getOneOfTypes(): array
    {
        return [
            'string',
            '\Camunda\Orchestration\Api\Model\AdvancedElementIdFilter'
        ];
    }
