...
/**
 * IntegerFilterProperty Class Doc Comment
 *
 ...
 * @link     https://openapi-generator.tech
 */
class IntegerFilterProperty implements OneOfInterface
{
    /**
     ...
     * @var string
     */
    public const MODEL_NAME = 'IntegerFilterProperty';
    ...
    public static function getOneOfTypes(): array
    {
        return [
            'int',
            '\Camunda\Orchestration\Api\Model\AdvancedIntegerFilter'
        ];
    }
