...
/**
 * JobBatchUpdateRequest Class Doc Comment
 *
 ...
 */
class JobBatchUpdateRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'JobBatchUpdateRequest';
     ...
     * Gets filter
     *
     * @return \Camunda\Orchestration\Api\Model\JobFilter
     */
     ...
     * Sets filter
     *
     * @param \Camunda\Orchestration\Api\Model\JobFilter $filter The job filter. At least one dimension must be set.
     *
     * @return $this
     */
     ...
     * Sets changeset
     *
     * @param \Camunda\Orchestration\Api\Model\JobChangeset $changeset The fields to update. At least one field must be non-null.
     *
     * @return $this
     */
    ...
    public function setOperationReference(?int $operationReference): static
    {
        ...
        if (($operationReference < 1)) {
            throw new InvalidArgumentException('invalid value for $operationReference when calling JobBatchUpdateRequest., must be bigger than or equal to 1.');
        }
