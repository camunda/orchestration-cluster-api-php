...
/**
 * JobChangeset Class Doc Comment
 *
 ...
 */
class JobChangeset implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'JobChangeset';
     ...
     * Sets retries
     *
     * @param int|null $retries The new number of retries for the job.
     *
     * @return $this
     */
     ...
     * Sets timeout
     *
     * @param int|null $timeout The new timeout for the job in milliseconds.
     *
     * @return $this
     */
     ...
     * Sets priority
     *
     * @param int|null $priority The new priority for the job. Higher values indicate higher priority.
     *
     * @return $this
     */
