...
/**
 * JobResultCorrections Class Doc Comment
 *
 ...
 */
class JobResultCorrections implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'JobResultCorrections';
     ...
     * Sets assignee
     *
     * @param string|null $assignee Assignee of the task.
     *
     * @return $this
     */
     ...
     * Sets followUpDate
     *
     * @param \DateTime|null $followUpDate The follow-up date of the task.
     *
     * @return $this
     */
     ...
     * Sets candidateUsers
     *
     * @param string[]|null $candidateUsers The list of candidate users of the task.
     *
     * @return $this
     */
     ...
     *
     * @param string[]|null $candidateGroups The list of candidate groups of the task.
     *
     * @return $this
     */
    ...
    public function setPriority(?int $priority): static
    {
        ...
        if (!is_null($priority) && ($priority > 100)) {
            throw new InvalidArgumentException('invalid value for $priority when calling JobResultCorrections., must be smaller than or equal to 100.');
        }
        if (!is_null($priority) && ($priority < 0)) {
            throw new InvalidArgumentException('invalid value for $priority when calling JobResultCorrections., must be bigger than or equal to 0.');
        }
