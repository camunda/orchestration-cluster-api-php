...
/**
 * ProcessInstanceCancellationBatchOperationRequest Class Doc Comment
 *
 ...
 */
class ProcessInstanceCancellationBatchOperationRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ProcessInstanceCancellationBatchOperationRequest';
    ...
    public function setOperationReference(?int $operationReference): static
    {
        ...
        if (($operationReference < 1)) {
            throw new InvalidArgumentException('invalid value for $operationReference when calling ProcessInstanceCancellationBatchOperationRequest., must be bigger than or equal to 1.');
        }
