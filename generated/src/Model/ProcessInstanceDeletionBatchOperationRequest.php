...
/**
 * ProcessInstanceDeletionBatchOperationRequest Class Doc Comment
 *
 ...
 */
class ProcessInstanceDeletionBatchOperationRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ProcessInstanceDeletionBatchOperationRequest';
    ...
    public function setOperationReference(?int $operationReference): static
    {
        ...
        if (($operationReference < 1)) {
            throw new InvalidArgumentException('invalid value for $operationReference when calling ProcessInstanceDeletionBatchOperationRequest., must be bigger than or equal to 1.');
        }
