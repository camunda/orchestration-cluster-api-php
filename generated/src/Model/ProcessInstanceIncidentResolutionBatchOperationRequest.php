...
/**
 * ProcessInstanceIncidentResolutionBatchOperationRequest Class Doc Comment
 *
 ...
 */
class ProcessInstanceIncidentResolutionBatchOperationRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ProcessInstanceIncidentResolutionBatchOperationRequest';
    ...
    public function setOperationReference(?int $operationReference): static
    {
        ...
        if (($operationReference < 1)) {
            throw new InvalidArgumentException('invalid value for $operationReference when calling ProcessInstanceIncidentResolutionBatchOperationRequest., must be bigger than or equal to 1.');
        }
