...
/**
 * ProcessInstanceResumptionBatchOperationRequest Class Doc Comment
 *
 ...
 */
class ProcessInstanceResumptionBatchOperationRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ProcessInstanceResumptionBatchOperationRequest';
    ...
    public function setOperationReference(?int $operationReference): static
    {
        ...
        if (($operationReference < 1)) {
            throw new InvalidArgumentException('invalid value for $operationReference when calling ProcessInstanceResumptionBatchOperationRequest., must be bigger than or equal to 1.');
        }
