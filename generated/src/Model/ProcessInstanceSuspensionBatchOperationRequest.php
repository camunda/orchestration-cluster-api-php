...
/**
 * ProcessInstanceSuspensionBatchOperationRequest Class Doc Comment
 *
 ...
 */
class ProcessInstanceSuspensionBatchOperationRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ProcessInstanceSuspensionBatchOperationRequest';
    ...
    public function setOperationReference(?int $operationReference): static
    {
        ...
        if (($operationReference < 1)) {
            throw new InvalidArgumentException('invalid value for $operationReference when calling ProcessInstanceSuspensionBatchOperationRequest., must be bigger than or equal to 1.');
        }
