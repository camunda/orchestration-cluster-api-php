 ...
 */
class SecretListResult implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'SecretListResult';
     ...
     * Sets references
     *
     * @param string[] $references The secret references, each of the form `camunda.secrets.<name>`.
     *
     * @return $this
     */
