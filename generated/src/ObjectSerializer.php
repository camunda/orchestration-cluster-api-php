...
use Camunda\Orchestration\Api\Model\ModelInterface;
...
class ObjectSerializer
{
    ...
    public static function deserialize(mixed $data, string $class, ?array $httpHeaders = null): mixed
    {
        ...
        if (is_subclass_of($class, '\Camunda\Orchestration\Semantic\SemanticKey')) {
        ...
        if (is_subclass_of($class, '\BackedEnum')) {
            ...
            if (is_subclass_of($class, '\Camunda\Orchestration\Api\Model\OneOfInterface')) {
                return self::deserializeOneOf($data, $class, $httpHeaders);
            }
            if (is_subclass_of($class, '\Camunda\Orchestration\Api\Model\AnyOfInterface')) {
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
                $subclass = '\Camunda\Orchestration\Api\Model\\' . $data->{$discriminator};
