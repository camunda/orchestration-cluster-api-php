...
/**
 * Flat, asynchronous (Guzzle promise) facade over every generated Camunda Orchestration Cluster
 * API operation.
 *
 ...
 * @internal
 */
trait GeneratedAsyncOperations
{
    /**
    ...
    {
        return $this->api(\Camunda\Orchestration\Api\Api\AdHocSubProcessApi::class)->activateAdHocSubProcessActivitiesAsync($adHocSubProcessInstanceKey, $adHocSubProcessActivateActivitiesInstruction, $contentType);
    }
     ...
     *
     */
    public function getAgentDefinition(string $agentDefinitionKey, string $contentType = \Camunda\Orchestration\Api\Api\AgentDefinitionApi::contentTypes['getAgentDefinition'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\AgentDefinitionApi::class)->getAgentDefinitionAsync($agentDefinitionKey, $contentType);
    }
     ...
     *
     */
    public function searchAgentDefinitions(?\Camunda\Orchestration\Api\Model\AgentDefinitionSearchQuery $agentDefinitionSearchQuery = null, string $contentType = \Camunda\Orchestration\Api\Api\AgentDefinitionApi::contentTypes['searchAgentDefinitions'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\AgentDefinitionApi::class)->searchAgentDefinitionsAsync($agentDefinitionSearchQuery, $contentType);
    }
     ...
     *
     */
    public function createAgentInstance(\Camunda\Orchestration\Api\Model\AgentInstanceCreationRequest $agentInstanceCreationRequest, string $contentType = \Camunda\Orchestration\Api\Api\AgentInstanceApi::contentTypes['createAgentInstance'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\AgentInstanceApi::class)->createAgentInstanceAsync($agentInstanceCreationRequest, $contentType);
    }
     ...
     *
     */
    public function getAgentInstance(string $agentInstanceKey, string $contentType = \Camunda\Orchestration\Api\Api\AgentInstanceApi::contentTypes['getAgentInstance'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\AgentInstanceApi::class)->getAgentInstanceAsync($agentInstanceKey, $contentType);
    }
     ...
     *
     */
    public function searchAgentInstanceHistory(string $agentInstanceKey, ?\Camunda\Orchestration\Api\Model\AgentInstanceHistorySearchQuery $agentInstanceHistorySearchQuery = null, string $contentType = \Camunda\Orchestration\Api\Api\AgentInstanceApi::contentTypes['searchAgentInstanceHistory'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\AgentInstanceApi::class)->searchAgentInstanceHistoryAsync($agentInstanceKey, $agentInstanceHistorySearchQuery, $contentType);
    }
     ...
     *
     */
    public function searchAgentInstances(?\Camunda\Orchestration\Api\Model\AgentInstanceSearchQuery $agentInstanceSearchQuery = null, string $contentType = \Camunda\Orchestration\Api\Api\AgentInstanceApi::contentTypes['searchAgentInstances'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\AgentInstanceApi::class)->searchAgentInstancesAsync($agentInstanceSearchQuery, $contentType);
    }
     ...
     *
     */
    public function updateAgentInstance(string $agentInstanceKey, \Camunda\Orchestration\Api\Model\AgentInstanceUpdateRequest $agentInstanceUpdateRequest, string $contentType = \Camunda\Orchestration\Api\Api\AgentInstanceApi::contentTypes['updateAgentInstance'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\AgentInstanceApi::class)->updateAgentInstanceAsync($agentInstanceKey, $agentInstanceUpdateRequest, $contentType);
    }
     ...
     *
     */
    public function getAuditLog(string $auditLogKey, string $contentType = \Camunda\Orchestration\Api\Api\AuditLogApi::contentTypes['getAuditLog'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\AuditLogApi::class)->getAuditLogAsync($auditLogKey, $contentType);
    }
     ...
     *
     */
    public function searchAuditLogs(?\Camunda\Orchestration\Api\Model\AuditLogSearchQueryRequest $auditLogSearchQueryRequest = null, string $contentType = \Camunda\Orchestration\Api\Api\AuditLogApi::contentTypes['searchAuditLogs'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\AuditLogApi::class)->searchAuditLogsAsync($auditLogSearchQueryRequest, $contentType);
    }
     ...
     *
     */
    public function getAuthentication(string $contentType = \Camunda\Orchestration\Api\Api\AuthenticationApi::contentTypes['getAuthentication'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\AuthenticationApi::class)->getAuthenticationAsync($contentType);
    }
     ...
     *
     */
    public function searchOwnAuthorizations(?\Camunda\Orchestration\Api\Model\AuthorizationSearchQuery $authorizationSearchQuery = null, string $contentType = \Camunda\Orchestration\Api\Api\AuthenticationApi::contentTypes['searchOwnAuthorizations'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\AuthenticationApi::class)->searchOwnAuthorizationsAsync($authorizationSearchQuery, $contentType);
    }
    ...
    {
        return $this->api(\Camunda\Orchestration\Api\Api\AuthorizationApi::class)->createAuthorizationAsync($authorizationRequest, $contentType);
    }
     ...
     *
     */
    public function deleteAuthorization(string $authorizationKey, string $contentType = \Camunda\Orchestration\Api\Api\AuthorizationApi::contentTypes['deleteAuthorization'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\AuthorizationApi::class)->deleteAuthorizationAsync($authorizationKey, $contentType);
    }
     ...
     *
     */
    public function getAuthorization(string $authorizationKey, string $contentType = \Camunda\Orchestration\Api\Api\AuthorizationApi::contentTypes['getAuthorization'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\AuthorizationApi::class)->getAuthorizationAsync($authorizationKey, $contentType);
    }
     ...
     *
     */
    public function searchAuthorizations(?\Camunda\Orchestration\Api\Model\AuthorizationSearchQuery $authorizationSearchQuery = null, string $contentType = \Camunda\Orchestration\Api\Api\AuthorizationApi::contentTypes['searchAuthorizations'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\AuthorizationApi::class)->searchAuthorizationsAsync($authorizationSearchQuery, $contentType);
    }
     ...
     *
     */
    public function updateAuthorization(string $authorizationKey, \Camunda\Orchestration\Api\Model\AuthorizationIdBasedRequest|\Camunda\Orchestration\Api\Model\AuthorizationPropertyBasedRequest $authorizationRequest, string $contentType = \Camunda\Orchestration\Api\Api\AuthorizationApi::contentTypes['updateAuthorization'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\AuthorizationApi::class)->updateAuthorizationAsync($authorizationKey, $authorizationRequest, $contentType);
    }
     ...
     *
     */
    public function deleteHistoryBackup(int $backupId, string $contentType = \Camunda\Orchestration\Api\Api\BackupApi::contentTypes['deleteHistoryBackup'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\BackupApi::class)->deleteHistoryBackupAsync($backupId, $contentType);
    }
     ...
     *
     */
    public function deleteHistoryBackupAsClusterAdmin(int $backupId, ?string $physicalTenantId = null, ?int $hostIndex = null, array $variables = [], string $contentType = \Camunda\Orchestration\Api\Api\BackupApi::contentTypes['deleteHistoryBackupAsClusterAdmin'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\BackupApi::class)->deleteHistoryBackupAsClusterAdminAsync($backupId, $physicalTenantId, $hostIndex, $variables, $contentType);
    }
     ...
     *
     */
    public function deleteRuntimeBackup(int $backupId, string $contentType = \Camunda\Orchestration\Api\Api\BackupApi::contentTypes['deleteRuntimeBackup'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\BackupApi::class)->deleteRuntimeBackupAsync($backupId, $contentType);
    }
     ...
     *
     */
    public function deleteRuntimeBackupAsClusterAdmin(int $backupId, ?string $physicalTenantId = null, ?int $hostIndex = null, array $variables = [], string $contentType = \Camunda\Orchestration\Api\Api\BackupApi::contentTypes['deleteRuntimeBackupAsClusterAdmin'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\BackupApi::class)->deleteRuntimeBackupAsClusterAdminAsync($backupId, $physicalTenantId, $hostIndex, $variables, $contentType);
    }
     ...
     *
     */
    public function deleteRuntimeBackupState(string $contentType = \Camunda\Orchestration\Api\Api\BackupApi::contentTypes['deleteRuntimeBackupState'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\BackupApi::class)->deleteRuntimeBackupStateAsync($contentType);
    }
     ...
     *
     */
    public function deleteRuntimeBackupStateAsClusterAdmin(?string $physicalTenantId = null, ?int $hostIndex = null, array $variables = [], string $contentType = \Camunda\Orchestration\Api\Api\BackupApi::contentTypes['deleteRuntimeBackupStateAsClusterAdmin'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\BackupApi::class)->deleteRuntimeBackupStateAsClusterAdminAsync($physicalTenantId, $hostIndex, $variables, $contentType);
    }
     ...
     *
     */
    public function getHistoryBackup(int $backupId, string $contentType = \Camunda\Orchestration\Api\Api\BackupApi::contentTypes['getHistoryBackup'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\BackupApi::class)->getHistoryBackupAsync($backupId, $contentType);
    }
     ...
     *
     */
    public function getHistoryBackupAsClusterAdmin(int $backupId, ?string $physicalTenantId = null, ?int $hostIndex = null, array $variables = [], string $contentType = \Camunda\Orchestration\Api\Api\BackupApi::contentTypes['getHistoryBackupAsClusterAdmin'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\BackupApi::class)->getHistoryBackupAsClusterAdminAsync($backupId, $physicalTenantId, $hostIndex, $variables, $contentType);
    }
     ...
     *
     */
    public function getRuntimeBackup(int $backupId, string $contentType = \Camunda\Orchestration\Api\Api\BackupApi::contentTypes['getRuntimeBackup'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\BackupApi::class)->getRuntimeBackupAsync($backupId, $contentType);
    }
     ...
     *
     */
    public function getRuntimeBackupAsClusterAdmin(int $backupId, ?string $physicalTenantId = null, ?int $hostIndex = null, array $variables = [], string $contentType = \Camunda\Orchestration\Api\Api\BackupApi::contentTypes['getRuntimeBackupAsClusterAdmin'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\BackupApi::class)->getRuntimeBackupAsClusterAdminAsync($backupId, $physicalTenantId, $hostIndex, $variables, $contentType);
    }
     ...
     *
     */
    public function getRuntimeBackupState(string $contentType = \Camunda\Orchestration\Api\Api\BackupApi::contentTypes['getRuntimeBackupState'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\BackupApi::class)->getRuntimeBackupStateAsync($contentType);
    }
     ...
     *
     */
    public function getRuntimeBackupStateAsClusterAdmin(?string $physicalTenantId = null, ?int $hostIndex = null, array $variables = [], string $contentType = \Camunda\Orchestration\Api\Api\BackupApi::contentTypes['getRuntimeBackupStateAsClusterAdmin'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\BackupApi::class)->getRuntimeBackupStateAsClusterAdminAsync($physicalTenantId, $hostIndex, $variables, $contentType);
    }
     ...
     *
     */
    public function listHistoryBackups(?string $prefix = null, ?bool $verbose = true, string $contentType = \Camunda\Orchestration\Api\Api\BackupApi::contentTypes['listHistoryBackups'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\BackupApi::class)->listHistoryBackupsAsync($prefix, $verbose, $contentType);
    }
     ...
     *
     */
    public function listHistoryBackupsAsClusterAdmin(?string $physicalTenantId = null, ?string $prefix = null, ?bool $verbose = true, ?int $hostIndex = null, array $variables = [], string $contentType = \Camunda\Orchestration\Api\Api\BackupApi::contentTypes['listHistoryBackupsAsClusterAdmin'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\BackupApi::class)->listHistoryBackupsAsClusterAdminAsync($physicalTenantId, $prefix, $verbose, $hostIndex, $variables, $contentType);
    }
     ...
     *
     */
    public function listRuntimeBackups(?string $prefix = null, string $contentType = \Camunda\Orchestration\Api\Api\BackupApi::contentTypes['listRuntimeBackups'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\BackupApi::class)->listRuntimeBackupsAsync($prefix, $contentType);
    }
     ...
     *
     */
    public function listRuntimeBackupsAsClusterAdmin(?string $physicalTenantId = null, ?string $prefix = null, ?int $hostIndex = null, array $variables = [], string $contentType = \Camunda\Orchestration\Api\Api\BackupApi::contentTypes['listRuntimeBackupsAsClusterAdmin'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\BackupApi::class)->listRuntimeBackupsAsClusterAdminAsync($physicalTenantId, $prefix, $hostIndex, $variables, $contentType);
    }
     ...
     *
     */
    public function syncRuntimeBackupState(string $contentType = \Camunda\Orchestration\Api\Api\BackupApi::contentTypes['syncRuntimeBackupState'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\BackupApi::class)->syncRuntimeBackupStateAsync($contentType);
    }
     ...
     *
     */
    public function syncRuntimeBackupStateAsClusterAdmin(?string $physicalTenantId = null, ?int $hostIndex = null, array $variables = [], string $contentType = \Camunda\Orchestration\Api\Api\BackupApi::contentTypes['syncRuntimeBackupStateAsClusterAdmin'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\BackupApi::class)->syncRuntimeBackupStateAsClusterAdminAsync($physicalTenantId, $hostIndex, $variables, $contentType);
    }
     ...
     *
     */
    public function takeHistoryBackup(\Camunda\Orchestration\Api\Model\TakeHistoryBackupRequest $takeHistoryBackupRequest, string $contentType = \Camunda\Orchestration\Api\Api\BackupApi::contentTypes['takeHistoryBackup'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\BackupApi::class)->takeHistoryBackupAsync($takeHistoryBackupRequest, $contentType);
    }
     ...
     *
     */
    public function takeHistoryBackupAsClusterAdmin(\Camunda\Orchestration\Api\Model\TakeHistoryBackupRequest $takeHistoryBackupRequest, ?string $physicalTenantId = null, ?int $hostIndex = null, array $variables = [], string $contentType = \Camunda\Orchestration\Api\Api\BackupApi::contentTypes['takeHistoryBackupAsClusterAdmin'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\BackupApi::class)->takeHistoryBackupAsClusterAdminAsync($takeHistoryBackupRequest, $physicalTenantId, $hostIndex, $variables, $contentType);
    }
     ...
     *
     */
    public function takeRuntimeBackup(?\Camunda\Orchestration\Api\Model\TakeRuntimeBackupRequest $takeRuntimeBackupRequest = null, string $contentType = \Camunda\Orchestration\Api\Api\BackupApi::contentTypes['takeRuntimeBackup'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\BackupApi::class)->takeRuntimeBackupAsync($takeRuntimeBackupRequest, $contentType);
    }
    ...
    {
        return $this->api(\Camunda\Orchestration\Api\Api\BackupApi::class)->takeRuntimeBackupAsClusterAdminAsync($physicalTenantId, $takeRuntimeBackupRequest, $hostIndex, $variables, $contentType);
    }
     ...
     *
     */
    public function cancelBatchOperation(string $batchOperationKey, string $contentType = \Camunda\Orchestration\Api\Api\BatchOperationApi::contentTypes['cancelBatchOperation'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\BatchOperationApi::class)->cancelBatchOperationAsync($batchOperationKey, $contentType);
    }
     ...
     *
     */
    public function getBatchOperation(string $batchOperationKey, string $contentType = \Camunda\Orchestration\Api\Api\BatchOperationApi::contentTypes['getBatchOperation'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\BatchOperationApi::class)->getBatchOperationAsync($batchOperationKey, $contentType);
    }
     ...
     *
     */
    public function resumeBatchOperation(string $batchOperationKey, string $contentType = \Camunda\Orchestration\Api\Api\BatchOperationApi::contentTypes['resumeBatchOperation'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\BatchOperationApi::class)->resumeBatchOperationAsync($batchOperationKey, $contentType);
    }
     ...
     *
     */
    public function searchBatchOperationItems(?\Camunda\Orchestration\Api\Model\BatchOperationItemSearchQuery $batchOperationItemSearchQuery = null, string $contentType = \Camunda\Orchestration\Api\Api\BatchOperationApi::contentTypes['searchBatchOperationItems'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\BatchOperationApi::class)->searchBatchOperationItemsAsync($batchOperationItemSearchQuery, $contentType);
    }
     ...
     *
     */
    public function searchBatchOperations(?\Camunda\Orchestration\Api\Model\BatchOperationSearchQuery $batchOperationSearchQuery = null, string $contentType = \Camunda\Orchestration\Api\Api\BatchOperationApi::contentTypes['searchBatchOperations'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\BatchOperationApi::class)->searchBatchOperationsAsync($batchOperationSearchQuery, $contentType);
    }
     ...
     *
     */
    public function suspendBatchOperation(string $batchOperationKey, string $contentType = \Camunda\Orchestration\Api\Api\BatchOperationApi::contentTypes['suspendBatchOperation'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\BatchOperationApi::class)->suspendBatchOperationAsync($batchOperationKey, $contentType);
    }
     ...
     *
     */
    public function pinClock(\Camunda\Orchestration\Api\Model\ClockPinRequest $clockPinRequest, string $contentType = \Camunda\Orchestration\Api\Api\ClockApi::contentTypes['pinClock'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ClockApi::class)->pinClockAsync($clockPinRequest, $contentType);
    }
     ...
     *
     */
    public function resetClock(string $contentType = \Camunda\Orchestration\Api\Api\ClockApi::contentTypes['resetClock'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ClockApi::class)->resetClockAsync($contentType);
    }
     ...
     *
     */
    public function cancelClusterRebalance(?int $hostIndex = null, array $variables = [], string $contentType = \Camunda\Orchestration\Api\Api\ClusterApi::contentTypes['cancelClusterRebalance'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ClusterApi::class)->cancelClusterRebalanceAsync($hostIndex, $variables, $contentType);
    }
     ...
     *
     */
    public function getClusterRebalance(?int $hostIndex = null, array $variables = [], string $contentType = \Camunda\Orchestration\Api\Api\ClusterApi::contentTypes['getClusterRebalance'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ClusterApi::class)->getClusterRebalanceAsync($hostIndex, $variables, $contentType);
    }
     ...
     *
     */
    public function getClusterStatus(?int $hostIndex = null, array $variables = [], string $contentType = \Camunda\Orchestration\Api\Api\ClusterApi::contentTypes['getClusterStatus'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ClusterApi::class)->getClusterStatusAsync($hostIndex, $variables, $contentType);
    }
     ...
     *
     */
    public function getClusterTopology(?int $hostIndex = null, array $variables = [], string $contentType = \Camunda\Orchestration\Api\Api\ClusterApi::contentTypes['getClusterTopology'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ClusterApi::class)->getClusterTopologyAsync($hostIndex, $variables, $contentType);
    }
     ...
     *
     */
    public function getStatus(string $contentType = \Camunda\Orchestration\Api\Api\ClusterApi::contentTypes['getStatus'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ClusterApi::class)->getStatusAsync($contentType);
    }
     ...
     *
     */
    public function getTopology(string $contentType = \Camunda\Orchestration\Api\Api\ClusterApi::contentTypes['getTopology'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ClusterApi::class)->getTopologyAsync($contentType);
    }
     ...
     *
     */
    public function triggerClusterRebalance(?bool $dryRun = false, ?\Camunda\Orchestration\Api\Model\ClusterRebalanceRequest $clusterRebalanceRequest = null, ?int $hostIndex = null, array $variables = [], string $contentType = \Camunda\Orchestration\Api\Api\ClusterApi::contentTypes['triggerClusterRebalance'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ClusterApi::class)->triggerClusterRebalanceAsync($dryRun, $clusterRebalanceRequest, $hostIndex, $variables, $contentType);
    }
     ...
     *
     */
    public function createGlobalClusterVariable(\Camunda\Orchestration\Api\Model\CreateClusterVariableRequest $createClusterVariableRequest, string $contentType = \Camunda\Orchestration\Api\Api\ClusterVariableApi::contentTypes['createGlobalClusterVariable'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ClusterVariableApi::class)->createGlobalClusterVariableAsync($createClusterVariableRequest, $contentType);
    }
     ...
     *
     */
    public function createTenantClusterVariable(string $tenantId, \Camunda\Orchestration\Api\Model\CreateClusterVariableRequest $createClusterVariableRequest, string $contentType = \Camunda\Orchestration\Api\Api\ClusterVariableApi::contentTypes['createTenantClusterVariable'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ClusterVariableApi::class)->createTenantClusterVariableAsync($tenantId, $createClusterVariableRequest, $contentType);
    }
     ...
     *
     */
    public function deleteGlobalClusterVariable(string $name, string $contentType = \Camunda\Orchestration\Api\Api\ClusterVariableApi::contentTypes['deleteGlobalClusterVariable'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ClusterVariableApi::class)->deleteGlobalClusterVariableAsync($name, $contentType);
    }
     ...
     *
     */
    public function deleteTenantClusterVariable(string $tenantId, string $name, string $contentType = \Camunda\Orchestration\Api\Api\ClusterVariableApi::contentTypes['deleteTenantClusterVariable'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ClusterVariableApi::class)->deleteTenantClusterVariableAsync($tenantId, $name, $contentType);
    }
     ...
     *
     */
    public function getGlobalClusterVariable(string $name, string $contentType = \Camunda\Orchestration\Api\Api\ClusterVariableApi::contentTypes['getGlobalClusterVariable'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ClusterVariableApi::class)->getGlobalClusterVariableAsync($name, $contentType);
    }
     ...
     *
     */
    public function getTenantClusterVariable(string $tenantId, string $name, string $contentType = \Camunda\Orchestration\Api\Api\ClusterVariableApi::contentTypes['getTenantClusterVariable'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ClusterVariableApi::class)->getTenantClusterVariableAsync($tenantId, $name, $contentType);
    }
     ...
     *
     */
    public function searchClusterVariables(?bool $truncateValues = null, ?\Camunda\Orchestration\Api\Model\ClusterVariableSearchQueryRequest $clusterVariableSearchQueryRequest = null, string $contentType = \Camunda\Orchestration\Api\Api\ClusterVariableApi::contentTypes['searchClusterVariables'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ClusterVariableApi::class)->searchClusterVariablesAsync($truncateValues, $clusterVariableSearchQueryRequest, $contentType);
    }
     ...
     *
     */
    public function updateGlobalClusterVariable(string $name, \Camunda\Orchestration\Api\Model\UpdateClusterVariableRequest $updateClusterVariableRequest, string $contentType = \Camunda\Orchestration\Api\Api\ClusterVariableApi::contentTypes['updateGlobalClusterVariable'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ClusterVariableApi::class)->updateGlobalClusterVariableAsync($name, $updateClusterVariableRequest, $contentType);
    }
     ...
     *
     */
    public function updateTenantClusterVariable(string $tenantId, string $name, \Camunda\Orchestration\Api\Model\UpdateClusterVariableRequest $updateClusterVariableRequest, string $contentType = \Camunda\Orchestration\Api\Api\ClusterVariableApi::contentTypes['updateTenantClusterVariable'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ClusterVariableApi::class)->updateTenantClusterVariableAsync($tenantId, $name, $updateClusterVariableRequest, $contentType);
    }
     ...
     *
     */
    public function evaluateConditionals(\Camunda\Orchestration\Api\Model\ConditionalEvaluationInstruction $conditionalEvaluationInstruction, string $contentType = \Camunda\Orchestration\Api\Api\ConditionalApi::contentTypes['evaluateConditionals'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ConditionalApi::class)->evaluateConditionalsAsync($conditionalEvaluationInstruction, $contentType);
    }
     ...
     *
     */
    public function evaluateDecision(\Camunda\Orchestration\Api\Model\DecisionEvaluationById|\Camunda\Orchestration\Api\Model\DecisionEvaluationByKey $decisionEvaluationInstruction, string $contentType = \Camunda\Orchestration\Api\Api\DecisionDefinitionApi::contentTypes['evaluateDecision'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\DecisionDefinitionApi::class)->evaluateDecisionAsync($decisionEvaluationInstruction, $contentType);
    }
     ...
     *
     */
    public function getDecisionDefinition(string $decisionDefinitionKey, string $contentType = \Camunda\Orchestration\Api\Api\DecisionDefinitionApi::contentTypes['getDecisionDefinition'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\DecisionDefinitionApi::class)->getDecisionDefinitionAsync($decisionDefinitionKey, $contentType);
    }
     ...
     *
     */
    public function getDecisionDefinitionXML(string $decisionDefinitionKey, string $contentType = \Camunda\Orchestration\Api\Api\DecisionDefinitionApi::contentTypes['getDecisionDefinitionXML'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\DecisionDefinitionApi::class)->getDecisionDefinitionXMLAsync($decisionDefinitionKey, $contentType);
    }
     ...
     *
     */
    public function searchDecisionDefinitions(?\Camunda\Orchestration\Api\Model\DecisionDefinitionSearchQuery $decisionDefinitionSearchQuery = null, string $contentType = \Camunda\Orchestration\Api\Api\DecisionDefinitionApi::contentTypes['searchDecisionDefinitions'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\DecisionDefinitionApi::class)->searchDecisionDefinitionsAsync($decisionDefinitionSearchQuery, $contentType);
    }
     ...
     *
     */
    public function deleteDecisionInstance(string $decisionEvaluationKey, ?\Camunda\Orchestration\Api\Model\DeleteDecisionInstanceRequest $deleteDecisionInstanceRequest = null, string $contentType = \Camunda\Orchestration\Api\Api\DecisionInstanceApi::contentTypes['deleteDecisionInstance'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\DecisionInstanceApi::class)->deleteDecisionInstanceAsync($decisionEvaluationKey, $deleteDecisionInstanceRequest, $contentType);
    }
    ...
    {
        return $this->api(\Camunda\Orchestration\Api\Api\DecisionInstanceApi::class)->deleteDecisionInstancesBatchOperationAsync($decisionInstanceDeletionBatchOperationRequest, $contentType);
    }
     ...
     *
     */
    public function getDecisionInstance(string $decisionEvaluationInstanceKey, string $contentType = \Camunda\Orchestration\Api\Api\DecisionInstanceApi::contentTypes['getDecisionInstance'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\DecisionInstanceApi::class)->getDecisionInstanceAsync($decisionEvaluationInstanceKey, $contentType);
    }
     ...
     *
     */
    public function searchDecisionInstances(?\Camunda\Orchestration\Api\Model\DecisionInstanceSearchQuery $decisionInstanceSearchQuery = null, string $contentType = \Camunda\Orchestration\Api\Api\DecisionInstanceApi::contentTypes['searchDecisionInstances'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\DecisionInstanceApi::class)->searchDecisionInstancesAsync($decisionInstanceSearchQuery, $contentType);
    }
     ...
     *
     */
    public function getDecisionRequirements(string $decisionRequirementsKey, string $contentType = \Camunda\Orchestration\Api\Api\DecisionRequirementsApi::contentTypes['getDecisionRequirements'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\DecisionRequirementsApi::class)->getDecisionRequirementsAsync($decisionRequirementsKey, $contentType);
    }
     ...
     *
     */
    public function getDecisionRequirementsXML(string $decisionRequirementsKey, string $contentType = \Camunda\Orchestration\Api\Api\DecisionRequirementsApi::contentTypes['getDecisionRequirementsXML'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\DecisionRequirementsApi::class)->getDecisionRequirementsXMLAsync($decisionRequirementsKey, $contentType);
    }
     ...
     *
     */
    public function searchDecisionRequirements(?\Camunda\Orchestration\Api\Model\DecisionRequirementsSearchQuery $decisionRequirementsSearchQuery = null, string $contentType = \Camunda\Orchestration\Api\Api\DecisionRequirementsApi::contentTypes['searchDecisionRequirements'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\DecisionRequirementsApi::class)->searchDecisionRequirementsAsync($decisionRequirementsSearchQuery, $contentType);
    }
     ...
     *
     */
    public function createDocument(\SplFileObject $file, ?string $storeId = null, ?string $documentId = null, ?\Camunda\Orchestration\Api\Model\DocumentMetadata $metadata = null, string $contentType = \Camunda\Orchestration\Api\Api\DocumentApi::contentTypes['createDocument'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\DocumentApi::class)->createDocumentAsync($file, $storeId, $documentId, $metadata, $contentType);
    }
     ...
     *
     */
    public function createDocumentLink(string $documentId, ?string $storeId = null, ?string $contentHash = null, ?\Camunda\Orchestration\Api\Model\DocumentLinkRequest $documentLinkRequest = null, string $contentType = \Camunda\Orchestration\Api\Api\DocumentApi::contentTypes['createDocumentLink'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\DocumentApi::class)->createDocumentLinkAsync($documentId, $storeId, $contentHash, $documentLinkRequest, $contentType);
    }
     ...
     *
     */
    public function createDocuments(array $files, ?string $storeId = null, ?array $metadataList = null, string $contentType = \Camunda\Orchestration\Api\Api\DocumentApi::contentTypes['createDocuments'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\DocumentApi::class)->createDocumentsAsync($files, $storeId, $metadataList, $contentType);
    }
     ...
     *
     */
    public function deleteDocument(string $documentId, ?string $storeId = null, string $contentType = \Camunda\Orchestration\Api\Api\DocumentApi::contentTypes['deleteDocument'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\DocumentApi::class)->deleteDocumentAsync($documentId, $storeId, $contentType);
    }
     ...
     *
     */
    public function getDocument(string $documentId, ?string $storeId = null, ?string $contentHash = null, string $contentType = \Camunda\Orchestration\Api\Api\DocumentApi::contentTypes['getDocument'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\DocumentApi::class)->getDocumentAsync($documentId, $storeId, $contentHash, $contentType);
    }
     ...
     *
     */
    public function createElementInstanceVariables(string $elementInstanceKey, \Camunda\Orchestration\Api\Model\SetVariableRequest $setVariableRequest, string $contentType = \Camunda\Orchestration\Api\Api\ElementInstanceApi::contentTypes['createElementInstanceVariables'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ElementInstanceApi::class)->createElementInstanceVariablesAsync($elementInstanceKey, $setVariableRequest, $contentType);
    }
     ...
     *
     */
    public function getElementInstance(string $elementInstanceKey, string $contentType = \Camunda\Orchestration\Api\Api\ElementInstanceApi::contentTypes['getElementInstance'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ElementInstanceApi::class)->getElementInstanceAsync($elementInstanceKey, $contentType);
    }
     ...
     *
     */
    public function searchElementInstanceIncidents(string $elementInstanceKey, \Camunda\Orchestration\Api\Model\IncidentSearchQuery $incidentSearchQuery, string $contentType = \Camunda\Orchestration\Api\Api\ElementInstanceApi::contentTypes['searchElementInstanceIncidents'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ElementInstanceApi::class)->searchElementInstanceIncidentsAsync($elementInstanceKey, $incidentSearchQuery, $contentType);
    }
     ...
     *
     */
    public function searchElementInstanceWaitStates(?\Camunda\Orchestration\Api\Model\ElementInstanceWaitStateQuery $elementInstanceWaitStateQuery = null, string $contentType = \Camunda\Orchestration\Api\Api\ElementInstanceApi::contentTypes['searchElementInstanceWaitStates'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ElementInstanceApi::class)->searchElementInstanceWaitStatesAsync($elementInstanceWaitStateQuery, $contentType);
    }
     ...
     *
     */
    public function searchElementInstances(?\Camunda\Orchestration\Api\Model\ElementInstanceSearchQuery $elementInstanceSearchQuery = null, string $contentType = \Camunda\Orchestration\Api\Api\ElementInstanceApi::contentTypes['searchElementInstances'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ElementInstanceApi::class)->searchElementInstancesAsync($elementInstanceSearchQuery, $contentType);
    }
     ...
     *
     */
    public function getClusterExportingStatus(?int $hostIndex = null, array $variables = [], string $contentType = \Camunda\Orchestration\Api\Api\ExportingApi::contentTypes['getClusterExportingStatus'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ExportingApi::class)->getClusterExportingStatusAsync($hostIndex, $variables, $contentType);
    }
     ...
     *
     */
    public function getExportingStatus(string $contentType = \Camunda\Orchestration\Api\Api\ExportingApi::contentTypes['getExportingStatus'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ExportingApi::class)->getExportingStatusAsync($contentType);
    }
     ...
     *
     */
    public function pauseClusterExporting(?bool $soft = false, ?int $hostIndex = null, array $variables = [], string $contentType = \Camunda\Orchestration\Api\Api\ExportingApi::contentTypes['pauseClusterExporting'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ExportingApi::class)->pauseClusterExportingAsync($soft, $hostIndex, $variables, $contentType);
    }
     ...
     *
     */
    public function pauseExporting(?bool $soft = false, string $contentType = \Camunda\Orchestration\Api\Api\ExportingApi::contentTypes['pauseExporting'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ExportingApi::class)->pauseExportingAsync($soft, $contentType);
    }
     ...
     *
     */
    public function resumeClusterExporting(?int $hostIndex = null, array $variables = [], string $contentType = \Camunda\Orchestration\Api\Api\ExportingApi::contentTypes['resumeClusterExporting'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ExportingApi::class)->resumeClusterExportingAsync($hostIndex, $variables, $contentType);
    }
     ...
     *
     */
    public function resumeExporting(string $contentType = \Camunda\Orchestration\Api\Api\ExportingApi::contentTypes['resumeExporting'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ExportingApi::class)->resumeExportingAsync($contentType);
    }
     ...
     *
     */
    public function evaluateExpression(\Camunda\Orchestration\Api\Model\ExpressionEvaluationRequest $expressionEvaluationRequest, string $contentType = \Camunda\Orchestration\Api\Api\ExpressionApi::contentTypes['evaluateExpression'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ExpressionApi::class)->evaluateExpressionAsync($expressionEvaluationRequest, $contentType);
    }
     ...
     *
     */
    public function getFormByKey(string $formKey, string $contentType = \Camunda\Orchestration\Api\Api\FormApi::contentTypes['getFormByKey'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\FormApi::class)->getFormByKeyAsync($formKey, $contentType);
    }
     ...
     *
     */
    public function createGlobalTaskListener(\Camunda\Orchestration\Api\Model\CreateGlobalTaskListenerRequest $createGlobalTaskListenerRequest, string $contentType = \Camunda\Orchestration\Api\Api\GlobalListenerApi::contentTypes['createGlobalTaskListener'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\GlobalListenerApi::class)->createGlobalTaskListenerAsync($createGlobalTaskListenerRequest, $contentType);
    }
     ...
     *
     */
    public function deleteGlobalTaskListener(string $id, string $contentType = \Camunda\Orchestration\Api\Api\GlobalListenerApi::contentTypes['deleteGlobalTaskListener'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\GlobalListenerApi::class)->deleteGlobalTaskListenerAsync($id, $contentType);
    }
     ...
     *
     */
    public function getGlobalTaskListener(string $id, string $contentType = \Camunda\Orchestration\Api\Api\GlobalListenerApi::contentTypes['getGlobalTaskListener'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\GlobalListenerApi::class)->getGlobalTaskListenerAsync($id, $contentType);
    }
     ...
     *
     */
    public function searchGlobalTaskListeners(?\Camunda\Orchestration\Api\Model\GlobalTaskListenerSearchQueryRequest $globalTaskListenerSearchQueryRequest = null, string $contentType = \Camunda\Orchestration\Api\Api\GlobalListenerApi::contentTypes['searchGlobalTaskListeners'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\GlobalListenerApi::class)->searchGlobalTaskListenersAsync($globalTaskListenerSearchQueryRequest, $contentType);
    }
     ...
     *
     */
    public function updateGlobalTaskListener(string $id, \Camunda\Orchestration\Api\Model\UpdateGlobalTaskListenerRequest $updateGlobalTaskListenerRequest, string $contentType = \Camunda\Orchestration\Api\Api\GlobalListenerApi::contentTypes['updateGlobalTaskListener'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\GlobalListenerApi::class)->updateGlobalTaskListenerAsync($id, $updateGlobalTaskListenerRequest, $contentType);
    }
     ...
     *
     */
    public function assignClientToGroup(string $groupId, string $clientId, string $contentType = \Camunda\Orchestration\Api\Api\GroupApi::contentTypes['assignClientToGroup'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\GroupApi::class)->assignClientToGroupAsync($groupId, $clientId, $contentType);
    }
     ...
     *
     */
    public function assignMappingRuleToGroup(string $groupId, string $mappingRuleId, string $contentType = \Camunda\Orchestration\Api\Api\GroupApi::contentTypes['assignMappingRuleToGroup'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\GroupApi::class)->assignMappingRuleToGroupAsync($groupId, $mappingRuleId, $contentType);
    }
     ...
     *
     */
    public function assignUserToGroup(string $groupId, string $username, string $contentType = \Camunda\Orchestration\Api\Api\GroupApi::contentTypes['assignUserToGroup'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\GroupApi::class)->assignUserToGroupAsync($groupId, $username, $contentType);
    }
     ...
     *
     */
    public function createGroup(?\Camunda\Orchestration\Api\Model\GroupCreateRequest $groupCreateRequest = null, string $contentType = \Camunda\Orchestration\Api\Api\GroupApi::contentTypes['createGroup'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\GroupApi::class)->createGroupAsync($groupCreateRequest, $contentType);
    }
     ...
     *
     */
    public function deleteGroup(string $groupId, string $contentType = \Camunda\Orchestration\Api\Api\GroupApi::contentTypes['deleteGroup'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\GroupApi::class)->deleteGroupAsync($groupId, $contentType);
    }
     ...
     *
     */
    public function getGroup(string $groupId, string $contentType = \Camunda\Orchestration\Api\Api\GroupApi::contentTypes['getGroup'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\GroupApi::class)->getGroupAsync($groupId, $contentType);
    }
     ...
     *
     */
    public function searchClientsForGroup(string $groupId, ?\Camunda\Orchestration\Api\Model\GroupClientSearchQueryRequest $groupClientSearchQueryRequest = null, string $contentType = \Camunda\Orchestration\Api\Api\GroupApi::contentTypes['searchClientsForGroup'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\GroupApi::class)->searchClientsForGroupAsync($groupId, $groupClientSearchQueryRequest, $contentType);
    }
     ...
     *
     */
    public function searchGroups(?\Camunda\Orchestration\Api\Model\GroupSearchQueryRequest $groupSearchQueryRequest = null, string $contentType = \Camunda\Orchestration\Api\Api\GroupApi::contentTypes['searchGroups'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\GroupApi::class)->searchGroupsAsync($groupSearchQueryRequest, $contentType);
    }
     ...
     *
     */
    public function searchMappingRulesForGroup(string $groupId, ?\Camunda\Orchestration\Api\Model\MappingRuleSearchQueryRequest $mappingRuleSearchQueryRequest = null, string $contentType = \Camunda\Orchestration\Api\Api\GroupApi::contentTypes['searchMappingRulesForGroup'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\GroupApi::class)->searchMappingRulesForGroupAsync($groupId, $mappingRuleSearchQueryRequest, $contentType);
    }
     ...
     *
     */
    public function searchRolesForGroup(string $groupId, ?\Camunda\Orchestration\Api\Model\RoleSearchQueryRequest $roleSearchQueryRequest = null, string $contentType = \Camunda\Orchestration\Api\Api\GroupApi::contentTypes['searchRolesForGroup'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\GroupApi::class)->searchRolesForGroupAsync($groupId, $roleSearchQueryRequest, $contentType);
    }
     ...
     *
     */
    public function searchUsersForGroup(string $groupId, ?\Camunda\Orchestration\Api\Model\GroupUserSearchQueryRequest $groupUserSearchQueryRequest = null, string $contentType = \Camunda\Orchestration\Api\Api\GroupApi::contentTypes['searchUsersForGroup'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\GroupApi::class)->searchUsersForGroupAsync($groupId, $groupUserSearchQueryRequest, $contentType);
    }
     ...
     *
     */
    public function unassignClientFromGroup(string $groupId, string $clientId, string $contentType = \Camunda\Orchestration\Api\Api\GroupApi::contentTypes['unassignClientFromGroup'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\GroupApi::class)->unassignClientFromGroupAsync($groupId, $clientId, $contentType);
    }
     ...
     *
     */
    public function unassignMappingRuleFromGroup(string $groupId, string $mappingRuleId, string $contentType = \Camunda\Orchestration\Api\Api\GroupApi::contentTypes['unassignMappingRuleFromGroup'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\GroupApi::class)->unassignMappingRuleFromGroupAsync($groupId, $mappingRuleId, $contentType);
    }
     ...
     *
     */
    public function unassignUserFromGroup(string $groupId, string $username, string $contentType = \Camunda\Orchestration\Api\Api\GroupApi::contentTypes['unassignUserFromGroup'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\GroupApi::class)->unassignUserFromGroupAsync($groupId, $username, $contentType);
    }
     ...
     *
     */
    public function updateGroup(string $groupId, \Camunda\Orchestration\Api\Model\GroupUpdateRequest $groupUpdateRequest, string $contentType = \Camunda\Orchestration\Api\Api\GroupApi::contentTypes['updateGroup'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\GroupApi::class)->updateGroupAsync($groupId, $groupUpdateRequest, $contentType);
    }
     ...
     *
     */
    public function getIncident(string $incidentKey, string $contentType = \Camunda\Orchestration\Api\Api\IncidentApi::contentTypes['getIncident'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\IncidentApi::class)->getIncidentAsync($incidentKey, $contentType);
    }
     ...
     *
     */
    public function getProcessInstanceStatisticsByDefinition(\Camunda\Orchestration\Api\Model\IncidentProcessInstanceStatisticsByDefinitionQuery $incidentProcessInstanceStatisticsByDefinitionQuery, string $contentType = \Camunda\Orchestration\Api\Api\IncidentApi::contentTypes['getProcessInstanceStatisticsByDefinition'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\IncidentApi::class)->getProcessInstanceStatisticsByDefinitionAsync($incidentProcessInstanceStatisticsByDefinitionQuery, $contentType);
    }
     ...
     *
     */
    public function getProcessInstanceStatisticsByError(?\Camunda\Orchestration\Api\Model\IncidentProcessInstanceStatisticsByErrorQuery $incidentProcessInstanceStatisticsByErrorQuery = null, string $contentType = \Camunda\Orchestration\Api\Api\IncidentApi::contentTypes['getProcessInstanceStatisticsByError'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\IncidentApi::class)->getProcessInstanceStatisticsByErrorAsync($incidentProcessInstanceStatisticsByErrorQuery, $contentType);
    }
     ...
     *
     */
    public function resolveIncident(string $incidentKey, ?\Camunda\Orchestration\Api\Model\IncidentResolutionRequest $incidentResolutionRequest = null, string $contentType = \Camunda\Orchestration\Api\Api\IncidentApi::contentTypes['resolveIncident'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\IncidentApi::class)->resolveIncidentAsync($incidentKey, $incidentResolutionRequest, $contentType);
    }
     ...
     *
     */
    public function searchIncidents(?\Camunda\Orchestration\Api\Model\IncidentSearchQuery $incidentSearchQuery = null, string $contentType = \Camunda\Orchestration\Api\Api\IncidentApi::contentTypes['searchIncidents'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\IncidentApi::class)->searchIncidentsAsync($incidentSearchQuery, $contentType);
    }
     ...
     *
     */
    public function activateJobs(\Camunda\Orchestration\Api\Model\JobActivationRequest $jobActivationRequest, string $contentType = \Camunda\Orchestration\Api\Api\JobApi::contentTypes['activateJobs'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\JobApi::class)->activateJobsAsync($jobActivationRequest, $contentType);
    }
     ...
     *
     */
    public function completeJob(string $jobKey, ?\Camunda\Orchestration\Api\Model\JobCompletionRequest $jobCompletionRequest = null, string $contentType = \Camunda\Orchestration\Api\Api\JobApi::contentTypes['completeJob'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\JobApi::class)->completeJobAsync($jobKey, $jobCompletionRequest, $contentType);
    }
     ...
     *
     */
    public function failJob(string $jobKey, ?\Camunda\Orchestration\Api\Model\JobFailRequest $jobFailRequest = null, string $contentType = \Camunda\Orchestration\Api\Api\JobApi::contentTypes['failJob'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\JobApi::class)->failJobAsync($jobKey, $jobFailRequest, $contentType);
    }
     ...
     *
     */
    public function getGlobalJobStatistics(\DateTime $from, \DateTime $to, ?string $jobType = null, string $contentType = \Camunda\Orchestration\Api\Api\JobApi::contentTypes['getGlobalJobStatistics'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\JobApi::class)->getGlobalJobStatisticsAsync($from, $to, $jobType, $contentType);
    }
     ...
     *
     */
    public function getJobErrorStatistics(\Camunda\Orchestration\Api\Model\JobErrorStatisticsQuery $jobErrorStatisticsQuery, string $contentType = \Camunda\Orchestration\Api\Api\JobApi::contentTypes['getJobErrorStatistics'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\JobApi::class)->getJobErrorStatisticsAsync($jobErrorStatisticsQuery, $contentType);
    }
     ...
     *
     */
    public function getJobTimeSeriesStatistics(\Camunda\Orchestration\Api\Model\JobTimeSeriesStatisticsQuery $jobTimeSeriesStatisticsQuery, string $contentType = \Camunda\Orchestration\Api\Api\JobApi::contentTypes['getJobTimeSeriesStatistics'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\JobApi::class)->getJobTimeSeriesStatisticsAsync($jobTimeSeriesStatisticsQuery, $contentType);
    }
     ...
     *
     */
    public function getJobTypeStatistics(\Camunda\Orchestration\Api\Model\JobTypeStatisticsQuery $jobTypeStatisticsQuery, string $contentType = \Camunda\Orchestration\Api\Api\JobApi::contentTypes['getJobTypeStatistics'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\JobApi::class)->getJobTypeStatisticsAsync($jobTypeStatisticsQuery, $contentType);
    }
     ...
     *
     */
    public function getJobWorkerStatistics(\Camunda\Orchestration\Api\Model\JobWorkerStatisticsQuery $jobWorkerStatisticsQuery, string $contentType = \Camunda\Orchestration\Api\Api\JobApi::contentTypes['getJobWorkerStatistics'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\JobApi::class)->getJobWorkerStatisticsAsync($jobWorkerStatisticsQuery, $contentType);
    }
     ...
     *
     */
    public function searchJobs(?\Camunda\Orchestration\Api\Model\JobSearchQuery $jobSearchQuery = null, string $contentType = \Camunda\Orchestration\Api\Api\JobApi::contentTypes['searchJobs'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\JobApi::class)->searchJobsAsync($jobSearchQuery, $contentType);
    }
     ...
     *
     */
    public function throwJobError(string $jobKey, \Camunda\Orchestration\Api\Model\JobErrorRequest $jobErrorRequest, string $contentType = \Camunda\Orchestration\Api\Api\JobApi::contentTypes['throwJobError'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\JobApi::class)->throwJobErrorAsync($jobKey, $jobErrorRequest, $contentType);
    }
     ...
     *
     */
    public function updateJob(string $jobKey, \Camunda\Orchestration\Api\Model\JobUpdateRequest $jobUpdateRequest, string $contentType = \Camunda\Orchestration\Api\Api\JobApi::contentTypes['updateJob'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\JobApi::class)->updateJobAsync($jobKey, $jobUpdateRequest, $contentType);
    }
     ...
     *
     */
    public function updateJobsBatchOperation(\Camunda\Orchestration\Api\Model\JobBatchUpdateRequest $jobBatchUpdateRequest, string $contentType = \Camunda\Orchestration\Api\Api\JobApi::contentTypes['updateJobsBatchOperation'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\JobApi::class)->updateJobsBatchOperationAsync($jobBatchUpdateRequest, $contentType);
    }
     ...
     *
     */
    public function getLicense(string $contentType = \Camunda\Orchestration\Api\Api\LicenseApi::contentTypes['getLicense'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\LicenseApi::class)->getLicenseAsync($contentType);
    }
     ...
     *
     */
    public function createMappingRule(?\Camunda\Orchestration\Api\Model\MappingRuleCreateRequest $mappingRuleCreateRequest = null, string $contentType = \Camunda\Orchestration\Api\Api\MappingRuleApi::contentTypes['createMappingRule'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\MappingRuleApi::class)->createMappingRuleAsync($mappingRuleCreateRequest, $contentType);
    }
     ...
     *
     */
    public function deleteMappingRule(string $mappingRuleId, string $contentType = \Camunda\Orchestration\Api\Api\MappingRuleApi::contentTypes['deleteMappingRule'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\MappingRuleApi::class)->deleteMappingRuleAsync($mappingRuleId, $contentType);
    }
     ...
     *
     */
    public function getMappingRule(string $mappingRuleId, string $contentType = \Camunda\Orchestration\Api\Api\MappingRuleApi::contentTypes['getMappingRule'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\MappingRuleApi::class)->getMappingRuleAsync($mappingRuleId, $contentType);
    }
     ...
     *
     */
    public function searchMappingRule(?\Camunda\Orchestration\Api\Model\MappingRuleSearchQueryRequest $mappingRuleSearchQueryRequest = null, string $contentType = \Camunda\Orchestration\Api\Api\MappingRuleApi::contentTypes['searchMappingRule'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\MappingRuleApi::class)->searchMappingRuleAsync($mappingRuleSearchQueryRequest, $contentType);
    }
     ...
     *
     */
    public function updateMappingRule(string $mappingRuleId, ?\Camunda\Orchestration\Api\Model\MappingRuleUpdateRequest $mappingRuleUpdateRequest = null, string $contentType = \Camunda\Orchestration\Api\Api\MappingRuleApi::contentTypes['updateMappingRule'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\MappingRuleApi::class)->updateMappingRuleAsync($mappingRuleId, $mappingRuleUpdateRequest, $contentType);
    }
     ...
     *
     */
    public function correlateMessage(\Camunda\Orchestration\Api\Model\MessageCorrelationRequest $messageCorrelationRequest, string $contentType = \Camunda\Orchestration\Api\Api\MessageApi::contentTypes['correlateMessage'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\MessageApi::class)->correlateMessageAsync($messageCorrelationRequest, $contentType);
    }
     ...
     *
     */
    public function publishMessage(\Camunda\Orchestration\Api\Model\MessagePublicationRequest $messagePublicationRequest, string $contentType = \Camunda\Orchestration\Api\Api\MessageApi::contentTypes['publishMessage'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\MessageApi::class)->publishMessageAsync($messagePublicationRequest, $contentType);
    }
    ...
    {
        return $this->api(\Camunda\Orchestration\Api\Api\MessageSubscriptionApi::class)->searchCorrelatedMessageSubscriptionsAsync($correlatedMessageSubscriptionSearchQuery, $contentType);
    }
     ...
     *
     */
    public function searchMessageSubscriptions(?\Camunda\Orchestration\Api\Model\MessageSubscriptionSearchQuery $messageSubscriptionSearchQuery = null, string $contentType = \Camunda\Orchestration\Api\Api\MessageSubscriptionApi::contentTypes['searchMessageSubscriptions'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\MessageSubscriptionApi::class)->searchMessageSubscriptionsAsync($messageSubscriptionSearchQuery, $contentType);
    }
     ...
     *
     */
    public function getProcessDefinition(string $processDefinitionKey, string $contentType = \Camunda\Orchestration\Api\Api\ProcessDefinitionApi::contentTypes['getProcessDefinition'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ProcessDefinitionApi::class)->getProcessDefinitionAsync($processDefinitionKey, $contentType);
    }
     ...
     *
     */
    public function getProcessDefinitionInstanceStatistics(?\Camunda\Orchestration\Api\Model\ProcessDefinitionInstanceStatisticsQuery $processDefinitionInstanceStatisticsQuery = null, string $contentType = \Camunda\Orchestration\Api\Api\ProcessDefinitionApi::contentTypes['getProcessDefinitionInstanceStatistics'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ProcessDefinitionApi::class)->getProcessDefinitionInstanceStatisticsAsync($processDefinitionInstanceStatisticsQuery, $contentType);
    }
     ...
     *
     */
    public function getProcessDefinitionInstanceVersionStatistics(\Camunda\Orchestration\Api\Model\ProcessDefinitionInstanceVersionStatisticsQuery $processDefinitionInstanceVersionStatisticsQuery, string $contentType = \Camunda\Orchestration\Api\Api\ProcessDefinitionApi::contentTypes['getProcessDefinitionInstanceVersionStatistics'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ProcessDefinitionApi::class)->getProcessDefinitionInstanceVersionStatisticsAsync($processDefinitionInstanceVersionStatisticsQuery, $contentType);
    }
     ...
     *
     */
    public function getProcessDefinitionMessageSubscriptionStatistics(?\Camunda\Orchestration\Api\Model\ProcessDefinitionMessageSubscriptionStatisticsQuery $processDefinitionMessageSubscriptionStatisticsQuery = null, string $contentType = \Camunda\Orchestration\Api\Api\ProcessDefinitionApi::contentTypes['getProcessDefinitionMessageSubscriptionStatistics'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ProcessDefinitionApi::class)->getProcessDefinitionMessageSubscriptionStatisticsAsync($processDefinitionMessageSubscriptionStatisticsQuery, $contentType);
    }
     ...
     *
     */
    public function getProcessDefinitionStatistics(string $processDefinitionKey, ?\Camunda\Orchestration\Api\Model\ProcessDefinitionElementStatisticsQuery $processDefinitionElementStatisticsQuery = null, string $contentType = \Camunda\Orchestration\Api\Api\ProcessDefinitionApi::contentTypes['getProcessDefinitionStatistics'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ProcessDefinitionApi::class)->getProcessDefinitionStatisticsAsync($processDefinitionKey, $processDefinitionElementStatisticsQuery, $contentType);
    }
     ...
     *
     */
    public function getProcessDefinitionXML(string $processDefinitionKey, string $contentType = \Camunda\Orchestration\Api\Api\ProcessDefinitionApi::contentTypes['getProcessDefinitionXML'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ProcessDefinitionApi::class)->getProcessDefinitionXMLAsync($processDefinitionKey, $contentType);
    }
     ...
     *
     */
    public function getStartProcessForm(string $processDefinitionKey, string $contentType = \Camunda\Orchestration\Api\Api\ProcessDefinitionApi::contentTypes['getStartProcessForm'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ProcessDefinitionApi::class)->getStartProcessFormAsync($processDefinitionKey, $contentType);
    }
     ...
     *
     */
    public function searchProcessDefinitionVariableNames(string $processDefinitionKey, ?\Camunda\Orchestration\Api\Model\ProcessDefinitionVariableNameSearchQuery $processDefinitionVariableNameSearchQuery = null, string $contentType = \Camunda\Orchestration\Api\Api\ProcessDefinitionApi::contentTypes['searchProcessDefinitionVariableNames'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ProcessDefinitionApi::class)->searchProcessDefinitionVariableNamesAsync($processDefinitionKey, $processDefinitionVariableNameSearchQuery, $contentType);
    }
     ...
     *
     */
    public function searchProcessDefinitions(?\Camunda\Orchestration\Api\Model\ProcessDefinitionSearchQuery $processDefinitionSearchQuery = null, string $contentType = \Camunda\Orchestration\Api\Api\ProcessDefinitionApi::contentTypes['searchProcessDefinitions'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ProcessDefinitionApi::class)->searchProcessDefinitionsAsync($processDefinitionSearchQuery, $contentType);
    }
    ...
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ProcessInstanceApi::class)->assignProcessInstanceBusinessIdAsync($processInstanceKey, $processInstanceBusinessIdAssignmentInstruction, $contentType);
    }
     ...
     *
     */
    public function cancelProcessInstance(string $processInstanceKey, ?\Camunda\Orchestration\Api\Model\CancelProcessInstanceRequest $cancelProcessInstanceRequest = null, string $contentType = \Camunda\Orchestration\Api\Api\ProcessInstanceApi::contentTypes['cancelProcessInstance'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ProcessInstanceApi::class)->cancelProcessInstanceAsync($processInstanceKey, $cancelProcessInstanceRequest, $contentType);
    }
     ...
     *
     */
    public function cancelProcessInstancesBatchOperation(\Camunda\Orchestration\Api\Model\ProcessInstanceCancellationBatchOperationRequest $processInstanceCancellationBatchOperationRequest, string $contentType = \Camunda\Orchestration\Api\Api\ProcessInstanceApi::contentTypes['cancelProcessInstancesBatchOperation'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ProcessInstanceApi::class)->cancelProcessInstancesBatchOperationAsync($processInstanceCancellationBatchOperationRequest, $contentType);
    }
     ...
     *
     */
    public function createProcessInstance(\Camunda\Orchestration\Api\Model\ProcessInstanceCreationInstructionByKey|\Camunda\Orchestration\Api\Model\ProcessInstanceCreationInstructionById $processInstanceCreationInstruction, string $contentType = \Camunda\Orchestration\Api\Api\ProcessInstanceApi::contentTypes['createProcessInstance'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ProcessInstanceApi::class)->createProcessInstanceAsync($processInstanceCreationInstruction, $contentType);
    }
     ...
     *
     */
    public function deleteProcessInstance(string $processInstanceKey, ?\Camunda\Orchestration\Api\Model\DeleteProcessInstanceRequest $deleteProcessInstanceRequest = null, string $contentType = \Camunda\Orchestration\Api\Api\ProcessInstanceApi::contentTypes['deleteProcessInstance'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ProcessInstanceApi::class)->deleteProcessInstanceAsync($processInstanceKey, $deleteProcessInstanceRequest, $contentType);
    }
     ...
     *
     */
    public function deleteProcessInstancesBatchOperation(\Camunda\Orchestration\Api\Model\ProcessInstanceDeletionBatchOperationRequest $processInstanceDeletionBatchOperationRequest, string $contentType = \Camunda\Orchestration\Api\Api\ProcessInstanceApi::contentTypes['deleteProcessInstancesBatchOperation'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ProcessInstanceApi::class)->deleteProcessInstancesBatchOperationAsync($processInstanceDeletionBatchOperationRequest, $contentType);
    }
     ...
     *
     */
    public function getProcessInstance(string $processInstanceKey, string $contentType = \Camunda\Orchestration\Api\Api\ProcessInstanceApi::contentTypes['getProcessInstance'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ProcessInstanceApi::class)->getProcessInstanceAsync($processInstanceKey, $contentType);
    }
     ...
     *
     */
    public function getProcessInstanceCallHierarchy(string $processInstanceKey, string $contentType = \Camunda\Orchestration\Api\Api\ProcessInstanceApi::contentTypes['getProcessInstanceCallHierarchy'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ProcessInstanceApi::class)->getProcessInstanceCallHierarchyAsync($processInstanceKey, $contentType);
    }
     ...
     *
     */
    public function getProcessInstanceSequenceFlows(string $processInstanceKey, string $contentType = \Camunda\Orchestration\Api\Api\ProcessInstanceApi::contentTypes['getProcessInstanceSequenceFlows'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ProcessInstanceApi::class)->getProcessInstanceSequenceFlowsAsync($processInstanceKey, $contentType);
    }
     ...
     *
     */
    public function getProcessInstanceStatistics(string $processInstanceKey, string $contentType = \Camunda\Orchestration\Api\Api\ProcessInstanceApi::contentTypes['getProcessInstanceStatistics'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ProcessInstanceApi::class)->getProcessInstanceStatisticsAsync($processInstanceKey, $contentType);
    }
     ...
     *
     */
    public function getProcessInstanceWaitStateStatistics(string $processInstanceKey, string $contentType = \Camunda\Orchestration\Api\Api\ProcessInstanceApi::contentTypes['getProcessInstanceWaitStateStatistics'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ProcessInstanceApi::class)->getProcessInstanceWaitStateStatisticsAsync($processInstanceKey, $contentType);
    }
    ...
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ProcessInstanceApi::class)->migrateProcessInstanceAsync($processInstanceKey, $processInstanceMigrationInstruction, $contentType);
    }
     ...
     *
     */
    public function migrateProcessInstancesBatchOperation(\Camunda\Orchestration\Api\Model\ProcessInstanceMigrationBatchOperationRequest $processInstanceMigrationBatchOperationRequest, string $contentType = \Camunda\Orchestration\Api\Api\ProcessInstanceApi::contentTypes['migrateProcessInstancesBatchOperation'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ProcessInstanceApi::class)->migrateProcessInstancesBatchOperationAsync($processInstanceMigrationBatchOperationRequest, $contentType);
    }
     ...
     *
     */
    public function modifyProcessInstance(string $processInstanceKey, \Camunda\Orchestration\Api\Model\ProcessInstanceModificationInstruction $processInstanceModificationInstruction, string $contentType = \Camunda\Orchestration\Api\Api\ProcessInstanceApi::contentTypes['modifyProcessInstance'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ProcessInstanceApi::class)->modifyProcessInstanceAsync($processInstanceKey, $processInstanceModificationInstruction, $contentType);
    }
     ...
     *
     */
    public function modifyProcessInstancesBatchOperation(\Camunda\Orchestration\Api\Model\ProcessInstanceModificationBatchOperationRequest $processInstanceModificationBatchOperationRequest, string $contentType = \Camunda\Orchestration\Api\Api\ProcessInstanceApi::contentTypes['modifyProcessInstancesBatchOperation'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ProcessInstanceApi::class)->modifyProcessInstancesBatchOperationAsync($processInstanceModificationBatchOperationRequest, $contentType);
    }
    ...
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ProcessInstanceApi::class)->resolveIncidentsBatchOperationAsync($processInstanceIncidentResolutionBatchOperationRequest, $contentType);
    }
     ...
     *
     */
    public function resolveProcessInstanceIncidents(string $processInstanceKey, string $contentType = \Camunda\Orchestration\Api\Api\ProcessInstanceApi::contentTypes['resolveProcessInstanceIncidents'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ProcessInstanceApi::class)->resolveProcessInstanceIncidentsAsync($processInstanceKey, $contentType);
    }
     ...
     *
     */
    public function resumeProcessInstance(string $processInstanceKey, ?\Camunda\Orchestration\Api\Model\ResumeProcessInstanceRequest $resumeProcessInstanceRequest = null, string $contentType = \Camunda\Orchestration\Api\Api\ProcessInstanceApi::contentTypes['resumeProcessInstance'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ProcessInstanceApi::class)->resumeProcessInstanceAsync($processInstanceKey, $resumeProcessInstanceRequest, $contentType);
    }
     ...
     *
     */
    public function resumeProcessInstancesBatchOperation(\Camunda\Orchestration\Api\Model\ProcessInstanceResumptionBatchOperationRequest $processInstanceResumptionBatchOperationRequest, string $contentType = \Camunda\Orchestration\Api\Api\ProcessInstanceApi::contentTypes['resumeProcessInstancesBatchOperation'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ProcessInstanceApi::class)->resumeProcessInstancesBatchOperationAsync($processInstanceResumptionBatchOperationRequest, $contentType);
    }
     ...
     *
     */
    public function searchProcessInstanceIncidents(string $processInstanceKey, ?\Camunda\Orchestration\Api\Model\IncidentSearchQuery $incidentSearchQuery = null, string $contentType = \Camunda\Orchestration\Api\Api\ProcessInstanceApi::contentTypes['searchProcessInstanceIncidents'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ProcessInstanceApi::class)->searchProcessInstanceIncidentsAsync($processInstanceKey, $incidentSearchQuery, $contentType);
    }
     ...
     *
     */
    public function searchProcessInstances(?\Camunda\Orchestration\Api\Model\ProcessInstanceSearchQuery $processInstanceSearchQuery = null, string $contentType = \Camunda\Orchestration\Api\Api\ProcessInstanceApi::contentTypes['searchProcessInstances'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ProcessInstanceApi::class)->searchProcessInstancesAsync($processInstanceSearchQuery, $contentType);
    }
     ...
     *
     */
    public function suspendProcessInstance(string $processInstanceKey, ?\Camunda\Orchestration\Api\Model\SuspendProcessInstanceRequest $suspendProcessInstanceRequest = null, string $contentType = \Camunda\Orchestration\Api\Api\ProcessInstanceApi::contentTypes['suspendProcessInstance'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ProcessInstanceApi::class)->suspendProcessInstanceAsync($processInstanceKey, $suspendProcessInstanceRequest, $contentType);
    }
    ...
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ProcessInstanceApi::class)->suspendProcessInstancesBatchOperationAsync($processInstanceSuspensionBatchOperationRequest, $contentType);
    }
     ...
     *
     */
    public function changeClusterMode(\Camunda\Orchestration\Api\Model\Mode $mode, ?bool $dryRun = false, string $contentType = \Camunda\Orchestration\Api\Api\RecoveryApi::contentTypes['changeClusterMode'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\RecoveryApi::class)->changeClusterModeAsync($mode, $dryRun, $contentType);
    }
    ...
    {
        return $this->api(\Camunda\Orchestration\Api\Api\RecoveryApi::class)->changeClusterModeAsClusterAdminAsync($mode, $physicalTenantId, $dryRun, $hostIndex, $variables, $contentType);
    }
     ...
     *
     */
    public function getRestoreStatus(string $contentType = \Camunda\Orchestration\Api\Api\RecoveryApi::contentTypes['getRestoreStatus'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\RecoveryApi::class)->getRestoreStatusAsync($contentType);
    }
     ...
     *
     */
    public function restore(\Camunda\Orchestration\Api\Model\RestoreRequest $restoreRequest, ?bool $dryRun = false, string $contentType = \Camunda\Orchestration\Api\Api\RecoveryApi::contentTypes['restore'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\RecoveryApi::class)->restoreAsync($restoreRequest, $dryRun, $contentType);
    }
     ...
     *
     */
    public function restoreAsClusterAdmin(\Camunda\Orchestration\Api\Model\ClusterRestoreRequest $clusterRestoreRequest, ?string $physicalTenantId = null, ?bool $dryRun = false, ?int $hostIndex = null, array $variables = [], string $contentType = \Camunda\Orchestration\Api\Api\RecoveryApi::contentTypes['restoreAsClusterAdmin'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\RecoveryApi::class)->restoreAsClusterAdminAsync($clusterRestoreRequest, $physicalTenantId, $dryRun, $hostIndex, $variables, $contentType);
    }
     ...
     *
     */
    public function createDeployment(array $resources, ?string $tenantId = null, string $contentType = \Camunda\Orchestration\Api\Api\ResourceApi::contentTypes['createDeployment'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ResourceApi::class)->createDeploymentAsync($resources, $tenantId, $contentType);
    }
     ...
     *
     */
    public function searchResources(?\Camunda\Orchestration\Api\Model\ResourceSearchQuery $resourceSearchQuery = null, string $contentType = \Camunda\Orchestration\Api\Api\ResourceApi::contentTypes['searchResources'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\ResourceApi::class)->searchResourcesAsync($resourceSearchQuery, $contentType);
    }
     ...
     *
     */
    public function assignRoleToClient(string $roleId, string $clientId, string $contentType = \Camunda\Orchestration\Api\Api\RoleApi::contentTypes['assignRoleToClient'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\RoleApi::class)->assignRoleToClientAsync($roleId, $clientId, $contentType);
    }
     ...
     *
     */
    public function assignRoleToGroup(string $roleId, string $groupId, string $contentType = \Camunda\Orchestration\Api\Api\RoleApi::contentTypes['assignRoleToGroup'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\RoleApi::class)->assignRoleToGroupAsync($roleId, $groupId, $contentType);
    }
     ...
     *
     */
    public function assignRoleToMappingRule(string $roleId, string $mappingRuleId, string $contentType = \Camunda\Orchestration\Api\Api\RoleApi::contentTypes['assignRoleToMappingRule'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\RoleApi::class)->assignRoleToMappingRuleAsync($roleId, $mappingRuleId, $contentType);
    }
     ...
     *
     */
    public function assignRoleToUser(string $roleId, string $username, string $contentType = \Camunda\Orchestration\Api\Api\RoleApi::contentTypes['assignRoleToUser'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\RoleApi::class)->assignRoleToUserAsync($roleId, $username, $contentType);
    }
     ...
     *
     */
    public function createRole(?\Camunda\Orchestration\Api\Model\RoleCreateRequest $roleCreateRequest = null, string $contentType = \Camunda\Orchestration\Api\Api\RoleApi::contentTypes['createRole'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\RoleApi::class)->createRoleAsync($roleCreateRequest, $contentType);
    }
     ...
     *
     */
    public function deleteRole(string $roleId, string $contentType = \Camunda\Orchestration\Api\Api\RoleApi::contentTypes['deleteRole'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\RoleApi::class)->deleteRoleAsync($roleId, $contentType);
    }
     ...
     *
     */
    public function getRole(string $roleId, string $contentType = \Camunda\Orchestration\Api\Api\RoleApi::contentTypes['getRole'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\RoleApi::class)->getRoleAsync($roleId, $contentType);
    }
     ...
     *
     */
    public function searchClientsForRole(string $roleId, ?\Camunda\Orchestration\Api\Model\RoleClientSearchQueryRequest $roleClientSearchQueryRequest = null, string $contentType = \Camunda\Orchestration\Api\Api\RoleApi::contentTypes['searchClientsForRole'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\RoleApi::class)->searchClientsForRoleAsync($roleId, $roleClientSearchQueryRequest, $contentType);
    }
     ...
     *
     */
    public function searchGroupsForRole(string $roleId, ?\Camunda\Orchestration\Api\Model\RoleGroupSearchQueryRequest $roleGroupSearchQueryRequest = null, string $contentType = \Camunda\Orchestration\Api\Api\RoleApi::contentTypes['searchGroupsForRole'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\RoleApi::class)->searchGroupsForRoleAsync($roleId, $roleGroupSearchQueryRequest, $contentType);
    }
     ...
     *
     */
    public function searchMappingRulesForRole(string $roleId, ?\Camunda\Orchestration\Api\Model\MappingRuleSearchQueryRequest $mappingRuleSearchQueryRequest = null, string $contentType = \Camunda\Orchestration\Api\Api\RoleApi::contentTypes['searchMappingRulesForRole'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\RoleApi::class)->searchMappingRulesForRoleAsync($roleId, $mappingRuleSearchQueryRequest, $contentType);
    }
     ...
     *
     */
    public function searchRoles(?\Camunda\Orchestration\Api\Model\RoleSearchQueryRequest $roleSearchQueryRequest = null, string $contentType = \Camunda\Orchestration\Api\Api\RoleApi::contentTypes['searchRoles'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\RoleApi::class)->searchRolesAsync($roleSearchQueryRequest, $contentType);
    }
     ...
     *
     */
    public function searchUsersForRole(string $roleId, ?\Camunda\Orchestration\Api\Model\RoleUserSearchQueryRequest $roleUserSearchQueryRequest = null, string $contentType = \Camunda\Orchestration\Api\Api\RoleApi::contentTypes['searchUsersForRole'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\RoleApi::class)->searchUsersForRoleAsync($roleId, $roleUserSearchQueryRequest, $contentType);
    }
     ...
     *
     */
    public function unassignRoleFromClient(string $roleId, string $clientId, string $contentType = \Camunda\Orchestration\Api\Api\RoleApi::contentTypes['unassignRoleFromClient'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\RoleApi::class)->unassignRoleFromClientAsync($roleId, $clientId, $contentType);
    }
     ...
     *
     */
    public function unassignRoleFromGroup(string $roleId, string $groupId, string $contentType = \Camunda\Orchestration\Api\Api\RoleApi::contentTypes['unassignRoleFromGroup'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\RoleApi::class)->unassignRoleFromGroupAsync($roleId, $groupId, $contentType);
    }
     ...
     *
     */
    public function unassignRoleFromMappingRule(string $roleId, string $mappingRuleId, string $contentType = \Camunda\Orchestration\Api\Api\RoleApi::contentTypes['unassignRoleFromMappingRule'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\RoleApi::class)->unassignRoleFromMappingRuleAsync($roleId, $mappingRuleId, $contentType);
    }
     ...
     *
     */
    public function unassignRoleFromUser(string $roleId, string $username, string $contentType = \Camunda\Orchestration\Api\Api\RoleApi::contentTypes['unassignRoleFromUser'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\RoleApi::class)->unassignRoleFromUserAsync($roleId, $username, $contentType);
    }
     ...
     *
     */
    public function updateRole(string $roleId, \Camunda\Orchestration\Api\Model\RoleUpdateRequest $roleUpdateRequest, string $contentType = \Camunda\Orchestration\Api\Api\RoleApi::contentTypes['updateRole'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\RoleApi::class)->updateRoleAsync($roleId, $roleUpdateRequest, $contentType);
    }
     ...
     *
     */
    public function listSecrets(?array $body = null, string $contentType = \Camunda\Orchestration\Api\Api\SecretApi::contentTypes['listSecrets'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\SecretApi::class)->listSecretsAsync($body, $contentType);
    }
     ...
     *
     */
    public function resolveSecrets(\Camunda\Orchestration\Api\Model\SecretResolveRequest $secretResolveRequest, string $contentType = \Camunda\Orchestration\Api\Api\SecretApi::contentTypes['resolveSecrets'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\SecretApi::class)->resolveSecretsAsync($secretResolveRequest, $contentType);
    }
     ...
     *
     */
    public function createAdminUser(\Camunda\Orchestration\Api\Model\UserRequest $userRequest, string $contentType = \Camunda\Orchestration\Api\Api\SetupApi::contentTypes['createAdminUser'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\SetupApi::class)->createAdminUserAsync($userRequest, $contentType);
    }
     ...
     *
     */
    public function broadcastSignal(\Camunda\Orchestration\Api\Model\SignalBroadcastRequest $signalBroadcastRequest, string $contentType = \Camunda\Orchestration\Api\Api\SignalApi::contentTypes['broadcastSignal'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\SignalApi::class)->broadcastSignalAsync($signalBroadcastRequest, $contentType);
    }
     ...
     *
     */
    public function getSystemConfiguration(string $contentType = \Camunda\Orchestration\Api\Api\SystemApi::contentTypes['getSystemConfiguration'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\SystemApi::class)->getSystemConfigurationAsync($contentType);
    }
     ...
     *
     */
    public function getUsageMetrics(\DateTime $startTime, \DateTime $endTime, ?string $tenantId = null, ?bool $withTenants = false, string $contentType = \Camunda\Orchestration\Api\Api\SystemApi::contentTypes['getUsageMetrics'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\SystemApi::class)->getUsageMetricsAsync($startTime, $endTime, $tenantId, $withTenants, $contentType);
    }
     ...
     *
     */
    public function assignClientToTenant(string $tenantId, string $clientId, string $contentType = \Camunda\Orchestration\Api\Api\TenantApi::contentTypes['assignClientToTenant'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\TenantApi::class)->assignClientToTenantAsync($tenantId, $clientId, $contentType);
    }
     ...
     *
     */
    public function assignGroupToTenant(string $tenantId, string $groupId, string $contentType = \Camunda\Orchestration\Api\Api\TenantApi::contentTypes['assignGroupToTenant'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\TenantApi::class)->assignGroupToTenantAsync($tenantId, $groupId, $contentType);
    }
     ...
     *
     */
    public function assignMappingRuleToTenant(string $tenantId, string $mappingRuleId, string $contentType = \Camunda\Orchestration\Api\Api\TenantApi::contentTypes['assignMappingRuleToTenant'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\TenantApi::class)->assignMappingRuleToTenantAsync($tenantId, $mappingRuleId, $contentType);
    }
     ...
     *
     */
    public function assignRoleToTenant(string $tenantId, string $roleId, string $contentType = \Camunda\Orchestration\Api\Api\TenantApi::contentTypes['assignRoleToTenant'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\TenantApi::class)->assignRoleToTenantAsync($tenantId, $roleId, $contentType);
    }
     ...
     *
     */
    public function assignUserToTenant(string $tenantId, string $username, string $contentType = \Camunda\Orchestration\Api\Api\TenantApi::contentTypes['assignUserToTenant'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\TenantApi::class)->assignUserToTenantAsync($tenantId, $username, $contentType);
    }
     ...
     *
     */
    public function createTenant(\Camunda\Orchestration\Api\Model\TenantCreateRequest $tenantCreateRequest, string $contentType = \Camunda\Orchestration\Api\Api\TenantApi::contentTypes['createTenant'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\TenantApi::class)->createTenantAsync($tenantCreateRequest, $contentType);
    }
     ...
     *
     */
    public function deleteTenant(string $tenantId, string $contentType = \Camunda\Orchestration\Api\Api\TenantApi::contentTypes['deleteTenant'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\TenantApi::class)->deleteTenantAsync($tenantId, $contentType);
    }
     ...
     *
     */
    public function getTenant(string $tenantId, string $contentType = \Camunda\Orchestration\Api\Api\TenantApi::contentTypes['getTenant'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\TenantApi::class)->getTenantAsync($tenantId, $contentType);
    }
     ...
     *
     */
    public function searchClientsForTenant(string $tenantId, ?\Camunda\Orchestration\Api\Model\TenantClientSearchQueryRequest $tenantClientSearchQueryRequest = null, string $contentType = \Camunda\Orchestration\Api\Api\TenantApi::contentTypes['searchClientsForTenant'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\TenantApi::class)->searchClientsForTenantAsync($tenantId, $tenantClientSearchQueryRequest, $contentType);
    }
     ...
     *
     */
    public function searchGroupIdsForTenant(string $tenantId, ?\Camunda\Orchestration\Api\Model\TenantGroupSearchQueryRequest $tenantGroupSearchQueryRequest = null, string $contentType = \Camunda\Orchestration\Api\Api\TenantApi::contentTypes['searchGroupIdsForTenant'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\TenantApi::class)->searchGroupIdsForTenantAsync($tenantId, $tenantGroupSearchQueryRequest, $contentType);
    }
     ...
     *
     */
    public function searchMappingRulesForTenant(string $tenantId, ?\Camunda\Orchestration\Api\Model\MappingRuleSearchQueryRequest $mappingRuleSearchQueryRequest = null, string $contentType = \Camunda\Orchestration\Api\Api\TenantApi::contentTypes['searchMappingRulesForTenant'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\TenantApi::class)->searchMappingRulesForTenantAsync($tenantId, $mappingRuleSearchQueryRequest, $contentType);
    }
     ...
     *
     */
    public function searchRolesForTenant(string $tenantId, ?\Camunda\Orchestration\Api\Model\RoleSearchQueryRequest $roleSearchQueryRequest = null, string $contentType = \Camunda\Orchestration\Api\Api\TenantApi::contentTypes['searchRolesForTenant'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\TenantApi::class)->searchRolesForTenantAsync($tenantId, $roleSearchQueryRequest, $contentType);
    }
     ...
     *
     */
    public function searchTenants(?\Camunda\Orchestration\Api\Model\TenantSearchQueryRequest $tenantSearchQueryRequest = null, string $contentType = \Camunda\Orchestration\Api\Api\TenantApi::contentTypes['searchTenants'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\TenantApi::class)->searchTenantsAsync($tenantSearchQueryRequest, $contentType);
    }
     ...
     *
     */
    public function searchUsersForTenant(string $tenantId, ?\Camunda\Orchestration\Api\Model\TenantUserSearchQueryRequest $tenantUserSearchQueryRequest = null, string $contentType = \Camunda\Orchestration\Api\Api\TenantApi::contentTypes['searchUsersForTenant'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\TenantApi::class)->searchUsersForTenantAsync($tenantId, $tenantUserSearchQueryRequest, $contentType);
    }
     ...
     *
     */
    public function unassignClientFromTenant(string $tenantId, string $clientId, string $contentType = \Camunda\Orchestration\Api\Api\TenantApi::contentTypes['unassignClientFromTenant'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\TenantApi::class)->unassignClientFromTenantAsync($tenantId, $clientId, $contentType);
    }
     ...
     *
     */
    public function unassignGroupFromTenant(string $tenantId, string $groupId, string $contentType = \Camunda\Orchestration\Api\Api\TenantApi::contentTypes['unassignGroupFromTenant'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\TenantApi::class)->unassignGroupFromTenantAsync($tenantId, $groupId, $contentType);
    }
     ...
     *
     */
    public function unassignMappingRuleFromTenant(string $tenantId, string $mappingRuleId, string $contentType = \Camunda\Orchestration\Api\Api\TenantApi::contentTypes['unassignMappingRuleFromTenant'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\TenantApi::class)->unassignMappingRuleFromTenantAsync($tenantId, $mappingRuleId, $contentType);
    }
     ...
     *
     */
    public function unassignRoleFromTenant(string $tenantId, string $roleId, string $contentType = \Camunda\Orchestration\Api\Api\TenantApi::contentTypes['unassignRoleFromTenant'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\TenantApi::class)->unassignRoleFromTenantAsync($tenantId, $roleId, $contentType);
    }
     ...
     *
     */
    public function unassignUserFromTenant(string $tenantId, string $username, string $contentType = \Camunda\Orchestration\Api\Api\TenantApi::contentTypes['unassignUserFromTenant'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\TenantApi::class)->unassignUserFromTenantAsync($tenantId, $username, $contentType);
    }
     ...
     *
     */
    public function updateTenant(string $tenantId, \Camunda\Orchestration\Api\Model\TenantUpdateRequest $tenantUpdateRequest, string $contentType = \Camunda\Orchestration\Api\Api\TenantApi::contentTypes['updateTenant'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\TenantApi::class)->updateTenantAsync($tenantId, $tenantUpdateRequest, $contentType);
    }
     ...
     *
     */
    public function createUser(\Camunda\Orchestration\Api\Model\UserRequest $userRequest, string $contentType = \Camunda\Orchestration\Api\Api\UserApi::contentTypes['createUser'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\UserApi::class)->createUserAsync($userRequest, $contentType);
    }
     ...
     *
     */
    public function deleteUser(string $username, string $contentType = \Camunda\Orchestration\Api\Api\UserApi::contentTypes['deleteUser'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\UserApi::class)->deleteUserAsync($username, $contentType);
    }
     ...
     *
     */
    public function getUser(string $username, string $contentType = \Camunda\Orchestration\Api\Api\UserApi::contentTypes['getUser'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\UserApi::class)->getUserAsync($username, $contentType);
    }
     ...
     *
     */
    public function searchUsers(?\Camunda\Orchestration\Api\Model\UserSearchQueryRequest $userSearchQueryRequest = null, string $contentType = \Camunda\Orchestration\Api\Api\UserApi::contentTypes['searchUsers'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\UserApi::class)->searchUsersAsync($userSearchQueryRequest, $contentType);
    }
     ...
     *
     */
    public function updateUser(string $username, \Camunda\Orchestration\Api\Model\UserUpdateRequest $userUpdateRequest, string $contentType = \Camunda\Orchestration\Api\Api\UserApi::contentTypes['updateUser'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\UserApi::class)->updateUserAsync($username, $userUpdateRequest, $contentType);
    }
     ...
     *
     */
    public function assignUserTask(string $userTaskKey, \Camunda\Orchestration\Api\Model\UserTaskAssignmentRequest $userTaskAssignmentRequest, string $contentType = \Camunda\Orchestration\Api\Api\UserTaskApi::contentTypes['assignUserTask'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\UserTaskApi::class)->assignUserTaskAsync($userTaskKey, $userTaskAssignmentRequest, $contentType);
    }
     ...
     *
     */
    public function completeUserTask(string $userTaskKey, ?\Camunda\Orchestration\Api\Model\UserTaskCompletionRequest $userTaskCompletionRequest = null, string $contentType = \Camunda\Orchestration\Api\Api\UserTaskApi::contentTypes['completeUserTask'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\UserTaskApi::class)->completeUserTaskAsync($userTaskKey, $userTaskCompletionRequest, $contentType);
    }
     ...
     *
     */
    public function getUserTask(string $userTaskKey, string $contentType = \Camunda\Orchestration\Api\Api\UserTaskApi::contentTypes['getUserTask'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\UserTaskApi::class)->getUserTaskAsync($userTaskKey, $contentType);
    }
     ...
     *
     */
    public function getUserTaskForm(string $userTaskKey, string $contentType = \Camunda\Orchestration\Api\Api\UserTaskApi::contentTypes['getUserTaskForm'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\UserTaskApi::class)->getUserTaskFormAsync($userTaskKey, $contentType);
    }
     ...
     *
     */
    public function searchUserTaskAuditLogs(string $userTaskKey, ?\Camunda\Orchestration\Api\Model\UserTaskAuditLogSearchQueryRequest $userTaskAuditLogSearchQueryRequest = null, string $contentType = \Camunda\Orchestration\Api\Api\UserTaskApi::contentTypes['searchUserTaskAuditLogs'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\UserTaskApi::class)->searchUserTaskAuditLogsAsync($userTaskKey, $userTaskAuditLogSearchQueryRequest, $contentType);
    }
    ...
    {
        return $this->api(\Camunda\Orchestration\Api\Api\UserTaskApi::class)->searchUserTaskEffectiveVariablesAsync($userTaskKey, $truncateValues, $userTaskEffectiveVariableSearchQueryRequest, $contentType);
    }
     ...
     *
     */
    public function searchUserTaskVariables(string $userTaskKey, ?bool $truncateValues = null, ?\Camunda\Orchestration\Api\Model\UserTaskVariableSearchQueryRequest $userTaskVariableSearchQueryRequest = null, string $contentType = \Camunda\Orchestration\Api\Api\UserTaskApi::contentTypes['searchUserTaskVariables'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\UserTaskApi::class)->searchUserTaskVariablesAsync($userTaskKey, $truncateValues, $userTaskVariableSearchQueryRequest, $contentType);
    }
     ...
     *
     */
    public function searchUserTasks(?\Camunda\Orchestration\Api\Model\UserTaskSearchQuery $userTaskSearchQuery = null, string $contentType = \Camunda\Orchestration\Api\Api\UserTaskApi::contentTypes['searchUserTasks'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\UserTaskApi::class)->searchUserTasksAsync($userTaskSearchQuery, $contentType);
    }
     ...
     *
     */
    public function unassignUserTask(string $userTaskKey, string $contentType = \Camunda\Orchestration\Api\Api\UserTaskApi::contentTypes['unassignUserTask'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\UserTaskApi::class)->unassignUserTaskAsync($userTaskKey, $contentType);
    }
     ...
     *
     */
    public function updateUserTask(string $userTaskKey, ?\Camunda\Orchestration\Api\Model\UserTaskUpdateRequest $userTaskUpdateRequest = null, string $contentType = \Camunda\Orchestration\Api\Api\UserTaskApi::contentTypes['updateUserTask'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\UserTaskApi::class)->updateUserTaskAsync($userTaskKey, $userTaskUpdateRequest, $contentType);
    }
     ...
     *
     */
    public function getVariable(string $variableKey, string $contentType = \Camunda\Orchestration\Api\Api\VariableApi::contentTypes['getVariable'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\VariableApi::class)->getVariableAsync($variableKey, $contentType);
    }
     ...
     *
     */
    public function searchVariables(?bool $truncateValues = null, ?\Camunda\Orchestration\Api\Model\VariableSearchQuery $variableSearchQuery = null, string $contentType = \Camunda\Orchestration\Api\Api\VariableApi::contentTypes['searchVariables'][0]): \GuzzleHttp\Promise\PromiseInterface
    {
        return $this->api(\Camunda\Orchestration\Api\Api\VariableApi::class)->searchVariablesAsync($truncateValues, $variableSearchQuery, $contentType);
    }
